...
$('.cancel').on('click', function() {
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            return fetch(FULLURL +'/cancel?id=' + id)
...
$('.approve').on('click', function() {
    ...
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            return fetch(FULLURL + '/approve?id=' + id)
...
$(document).on('change', '.unit_price', function() {
    ...
    const ifreight = parseFloat($this.parent().parent().find('td:nth-child(5) input.ifreight').val());
    ...
    setTimeout(function() {
        ...
        if ($('#total_pro_before_rebate').val() != '') {
            ...
            if ($('#rebate').val() != '') {
                ...
                $('#total_pro_percent').val(span_pro_percent.toFixed(2) + "%");
