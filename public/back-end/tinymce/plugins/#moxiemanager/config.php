...
// Filesystem
//$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/js/tinymce/uploads";  ///webroot/uploads';
$moxieManagerConfig['filesystem.rootpath'] = 'Upload=ftp://FileUpload;Images='.$_SERVER['DOCUMENT_ROOT'].'/upload';  ///webroot/uploads';
...
$moxieManagerConfig['ftp.accounts'] = array(
	'FileUpload' => array(
		'host' => 'ftp.jobslabo.com',
		'user' => 'jobslabo',
		'password' => 'b[%VcvyQZOa4',
		'rootpath' => '/public_html/upload',
		'wwwroot' => '/public_html/upload',
		'passive' => true
	)
);
