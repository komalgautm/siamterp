            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    <div class="card-header"> 
                        ...
                        <a href="/item" class="card-header-action">Item Management</a>
                        <div class="card-header-actions">
                            <button class="btn btn-default btn-sm" id="sort" data-text="Sort">Sort</button>
                            <a class="btn btn-sm btn-primary" href="{{url("/item/create")}}"> Create</a>
                                    ...
                                    @foreach($rows as $key => $row)
                                        <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                            ...
                                            <td>
                                                <div style='text-align: center;'>
                                                    ...
                                                    <img alt='Barcode Generator TEC-IT'
                                                         src="https://barcode.tec-it.com/barcode.ashx?data={{ $row->barcode }}&code=Code128&dpi=96&dataseparator="/>
                                                  </div>
                                                {{-- {!! DNS1D::getBarcodeHTML($row->barcode, 'C128') !!} --}}
                                                {{-- <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($row->barcode, 'C128')}}" alt="barcode"/> --}}
                                            ...
                                            <td data-label="Action">
                                                <a href="{{url("item/$row->id")}}" class="btn btn-secondary" title="Edit"><i class="far fa-edit"></i></a>                                                
