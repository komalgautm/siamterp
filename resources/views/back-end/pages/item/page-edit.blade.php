                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                ...
                                <div class="row"> 
                                    <div class="form-group col-lg-6">
                                        <h6>HS Code</h6>
                                        <input type="text" id="hs_code" name="hs_code" class="form-control" placeholder="HS Code" value="{{ $row->hs_code }}"/>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <h6>Scientific Name</h6>
                                        <input type="text" id="hs_name" name="hs_name" class="form-control" placeholder="Scientific Name" value="{{ $row->hs_name }}"/>
                                    </div>
                                </div>   
