                                ...
                                <div class="row"> 
                                    <div class="form-group col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control price" type="text" name="charge" placeholder="Price" value="{{ $row->charge }}" required>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Certificates</h6>
                                        <div class="input-group">
                                            <input class="form-control price" type="text" name="certificate" placeholder="Price" value="{{ $row->certificate }}" required>
                                            <div class="input-group-append"><span class="input-group-text">THB</span></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control price" type="text" name="chamber" placeholder="Price" value="{{ $row->chamber }}" required>
                                            <div class="input-group-append"><span class="input-group-text">THB</span></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <h6>Extras</h6>
                                        <div class="input-group">
                                            <input class="form-control price" type="text" name="extras" placeholder="Price" value="{{ $row->extras }}" required>
                                            <div class="input-group-append"><span class="input-group-text">THB</span></div>
                                        </div>
                                    </div>
                                </div>   
