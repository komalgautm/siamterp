        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    ...
                    <a href="{{url("$folder")}}" class="card-header-action">Ship To Management</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xs-12">
                                    ...
                                    <div class="input-group">                                        
                                        <input type="text" name="keyword" class="form-control" id="search" value="{{Request::get('keyword')}}" placeholder="Name/Company">
                                    ...
                                    @foreach($rows as $key => $row)
                                        <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                            ...
                                            <td data-label="Client">
                                                @php($client = \App\ClientModel::where('id',$row->client)->first())
                                                {{ $client->name }}
                                            </td>
