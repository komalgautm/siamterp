                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                <div class="row"> 
                                    <div class="form-group col-lg-4">
                                        <h6>Country</h6>
                                        <input type="text" id="country" name="country" class="form-control" placeholder="Country" value="{{ $row->country }}"/>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <h6>City</h6>
                                        <input type="text" id="city" name="city" class="form-control" placeholder="City" value="{{ $row->city }}"/>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <h6>Code</h6>
                                        <input type="text" id="airport_code" name="airport_code" class="form-control" placeholder="Code" value="{{ $row->airport_code }}"/>
                                    </div>
                                </div> 
