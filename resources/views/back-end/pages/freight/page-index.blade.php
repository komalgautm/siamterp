            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    <div class="card-header"> 
                        ...
                        <a href="{{ url("/$folder") }}" class="card-header-action">Freight Management</a>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                        ...
                                        <td data-label="Destination">
                                            @php($airport = \App\AirportModel::where('id',$row->destination)->first())
                                            {{ $airport->country.' - '.$airport->city.' ['.$airport->airport_code.']' }}
                                        </td>
                                        <td data-label="Airline">
                                            @php($airline = \App\AirlineModel::where('id',$row->airline)->first())
                                            {{ $airline->name.' ['.$airline->airline_code.']' }}
                                        </td>
