                                ...
                                <div class="row"> 
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" id="price" type="text" name="price" placeholder="Price" value="" required>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Volume</h6>
                                        <div class="input-group">
                                            <input class="form-control" id="volume" type="text" name="volume" placeholder="Volume" value="" required>
                                            <div class="input-group-append"><!-- <span class="input-group-text">cm</span> --></div>
                                        </div>
                                    </div>
                                </div>   
