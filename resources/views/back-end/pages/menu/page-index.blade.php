            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">                
                    <div class="card-header"> 
                        ...
                        <a href="/menu" class="card-header-action">Menu Management</a>
                        <div class="card-header-actions">
                            <button class="btn btn-default btn-sm" id="sort" data-text="Sort">Sort</button>
                            <a class="btn btn-sm btn-primary" href="{{url("/menu/create")}}"> Create</a>   
                                    ...
                                    @foreach($rows as $key => $row)
                                        ...
                                        <tr role="row" class="odd" data-row="{{$key+1}}" data-id="{{$row->id}}">
                                                    ...
                                                    @foreach($secondary as $col2)
                                                        <li class="list-group-item d-flex justify-content-between p-2">
                                                            ...
                                                            <div class="justify-content-end">
                                                                ...
                                                                <a class="badge badge-dark badge-status" data-id="{{$col2->id}}" href="javascript:">@if($col2->status =='on') off @else on @endif</a>
                                                                <a class="badge badge-warning" href="{{url("menu/$col2->id")}}">Edit</a>
                                            ...
                                            <td data-label="Action">
                                                <a href="{{url("menu/$row->id")}}" class="btn btn-secondary" title="Edit"><i class="far fa-edit"></i></a>                                                
