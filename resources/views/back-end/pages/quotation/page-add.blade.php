                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <select name="shipto" id="shipto" class="form-control select2"  style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row1" data-id="1">
                                        ...
                                        <td data-label="Profit">
                                            ...
                                            <input class="form-control profit" type="text" name="profit[]" placeholder="" required readonly>
