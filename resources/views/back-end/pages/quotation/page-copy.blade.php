         ...
         <form id="createForm" method="post" action="" enctype="multipart/form-data"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("/$folder")}}">Quotation Management</a></span>
                        <span class="breadcrumb-item active">Copy Form</span>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Ship To</h6>
                                        <select class="form-control select2" name="shipto" id="shipto" style="width:100%">
                                            <option value="">Select ship to</option>
                                            @if($row->shipto_id != '')
                                            <option value="{{ $shipto->id }}" @if($row->shipto_id == $shipto->id) selected @endif>{{ $shipto->name }}</option>
                                            @endif
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-3">
                            ...
                            <table class="table table-striped no-footer table-res" id="sorted_table" style="border-collapse: collapse !important" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row{{ $key+1 }}" class="rr-{{$key}}" data-id="{{ $key+1 }}">
                                        <td data-label="ITF">
                                            <select name="itf[]" id="itf{{ $key+1 }}" class="form-control select_itf select2" style="width:100%" required>
                                        ...
                                        <td data-label="Quantity">
                                            <input type="number" class="form-control qty" name="quantity[]" step="0.01" min="0" placeholder="Enter quantity" value="{{ $detail->qty }}" onchange="myFunction({{ $key+1 }})" required>
                                        ...
                                        <td data-label="Unit">
                                            <select onclick="changC(1)"  name="unitcount[]" id="unitcount{{ $key+1 }}" class="form-control unitcount" style="width:100%" required>
                                        ...
                                        <td data-label="NW" >
                                            ...
                                            <input type="hidden" class="form-control fixPrice" name="fixPrice[]" value="{{$detail->unit_price}}" placeholder="fixPrice">
                                        ...
                                        <td data-label="Unit Price">
                                            <div class="input-group">
                                                <input class="form-control unit_price" type="text" name="unit_price[]" placeholder="" value="{{ $detail->unit_price }}" required>
                                        ...
                                        <td data-label="Action">@if($key > 0) <a href="javascript:" class="btn btn-danger delete-row" data-id="{{ $detail->id }}" data-timing="remove" title="Delete"><i class="far fa-trash-alt"></i></a> @else &nbsp; @endif</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
