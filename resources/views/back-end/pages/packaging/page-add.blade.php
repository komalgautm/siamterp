                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                <div class="row"> 
                                    <div class="form-group col-lg-3">
                                        <h6>Pack</h6>
                                        <input type="text" id="pack" name="pack" class="form-control" placeholder="pack" value="" required/>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <h6>Weight</h6>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Wrap Cost</h6>
                                        <div class="input-group">
                                            <input class="form-control wrap_cost" step="0.01" type="number" name="wrap_cost" placeholder="wrap cost" required>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Wrap Weight</h6>
                                        <div class="input-group">
                                            <input class="form-control" id="wrap_weight" type="text" name="wrap_weight" placeholder="wrap weight" value="" required>
                                            <div class="input-group-append"><span class="input-group-text">g</span></div>
                                        </div>
                                    </div>
                                </div>
