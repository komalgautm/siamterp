            ...
            <form id="editForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("/$folder")}}">Currency Management</a></span>
                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                <div class="row"> 
                                    <div class="form-group col-lg-4">
                                        <h6>Currency</h6>
                                        <input type="text" id="currency" name="currency" class="form-control" placeholder="Code" value="{{ $row->currency }}"/>
                                    </div>
                                </div> 
