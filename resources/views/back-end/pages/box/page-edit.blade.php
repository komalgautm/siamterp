                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" id="width" type="text" name="width" placeholder="width" value="{{ $row->width }}" required>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <h6>Length</h6>
                                        <div class="input-group">
                                            <input class="form-control" id="length" type="text" name="length" placeholder="length" value="{{ $row->length }}" required>
                                            <div class="input-group-append"><span class="input-group-text">cm</span></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <h6>Height</h6>
                                        <div class="input-group">
                                            <input class="form-control" id="height" type="text" name="height" placeholder="height" value="{{ $row->height }}" required>
                                            <div class="input-group-append"><span class="input-group-text">cm</span></div>
                                        </div>
                                    </div>
                                </div>  
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3">
                                    <h6>CBM</h6>
                                    <input type="text" id="cbm" name="cbm" class="form-control" placeholder="automatic calculation" value="{{ $row->cbm }}" readonly/>
                                </div>
                                <div class="form-group col-lg-3">
                                    <h6>Weight</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-lg-3">
                                    <h6>MinLoad</h6>
                                    <input type="text" id="minload" name="minload" class="form-control" placeholder="automatic calculation" value="{{ $row->minload }}" readonly/>
                                </div>
                                <div class="form-group col-lg-3">
                                    <h6>Box/Pallet</h6>
                                    <input type="text" id="box_pallet" name="box_pallet" class="form-control" placeholder="box/pallet" value="{{ $row->box_pallet }}" required/>
                                </div>
                            </div>
                            {{-- <div class="row">
                                <div class="form-group col-lg-3">
