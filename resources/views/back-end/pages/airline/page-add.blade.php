            ...
            <form id="createForm" method="post" action="" enctype="multipart/form-data"> 
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="breadcrumb-item "><a href="{{url("/$folder")}}">Airline Management</a></span>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="TH" aria-labelledby="home-tab">
                                <div class="row"> 
                                    ...
                                    <div class="form-group col-lg-4">
                                        <h6>Code</h6>
                                        <input type="text" id="airline_code" name="airline_code" class="form-control" placeholder="Code" value=""/>
                                    </div>
                                </div>   
                            </div>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary" type="submit" id="signup">Create</button>
