...
$count_item = \App\InvoiceDetailModel::distinct('itf_id')->where('invoice_id',$id)->count('itf_id');
$count_box = 0;
 ...
 $code = \App\OrderModel::where('id',$order_id)->first()->code;
@endphp
<!DOCTYPE html>
<html>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:4px; margin-left:1%;">
        <tr>
            ...
            <td align="left" valign="top" style="padding-left:5px; width:500px;">
                ...
                <span class="fontsize16 colorblue">16/8 Mu 11 Khlong Nueng, Khlong Luang Pathumthani 12120</span> <br />
                <span class="fontsize16 colorblue">Tax ID 0395561000010</span>
            </td>
        </tr>
    </table>
