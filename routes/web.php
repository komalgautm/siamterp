...
Route::group(['middleware'=>['Webpanel']], function(){
	...
	Route::prefix('po')->group(function(){
		...
		Route::post('/dn','Webpanel\PO@debit_note');
		Route::post('/invoice_detail_update','Webpanel\PO@invoice_detail_update');
		Route::post('/payment','Webpanel\PO@payment');
		Route::post('/combined_payment','Webpanel\PO@combined_payment');
		...
		Route::get('/statementsExp','Webpanel\PDFController@statementsExp');
		Route::any('/statement','Webpanel\PO@statement');
		Route::get('/{id}/csv','Webpanel\CsvController@po');
	});
	...
	Route::prefix('packing')->group(function(){
		...
		Route::post('/registerWaste','Webpanel\Packing@registerWaste');
	});
	...
	Route::prefix('inventory')->group(function()
	{
		...
		Route::any('/adjust','Webpanel\Inventory@adjust');
	});
	...
	Route::prefix('quotation')->group(function(){
		...
		Route::get('/getTruck','Webpanel\Quotation@getTruck');
		...
		Route::get('/{id}/csv','Webpanel\CsvController@quotation');
	});
	...
	Route::prefix('order')->group(function(){
		...
		Route::get('/getITF','Webpanel\Order@getITF');
		Route::get('/getShip','Webpanel\Order@getShip');
		Route::get('/getAir','Webpanel\Order@getAir');
		Route::get('/getUnit','Webpanel\Order@getUnit');
		Route::get('/getVal','Webpanel\Order@getVal');
		Route::get('/getClearance','Webpanel\Order@getClearance');
		Route::get('/getCost','Webpanel\Order@getCost');
		Route::get('/getTruck','Webpanel\Order@getTruck');
		// Route::post('/getCost','Webpanel\Order@getCost');
		Route::get('/reCost','Webpanel\Order@reCost');
		Route::get('/getRate','Webpanel\Order@getRate');
		Route::get('/compareTransport','Webpanel\Order@compareTransport');
		Route::get('/cancel','Webpanel\Order@cancel');
		Route::get('/confirm','Webpanel\Order@confirm');
		Route::get('/destroyITF','Webpanel\Order@destroyITF');
		Route::get('/freight_detail','Webpanel\Order@freight_detail');
		Route::post('/update_freight_detail','Webpanel\Order@update_freight_detail');
		Route::get('/check_freight_detail','Webpanel\Order@check_freight_detail');
		Route::get('/oparetion/{id}','Webpanel\PDFController@oparetion');
		Route::get('/customs/{id}','Webpanel\PDFController@customs');
		Route::get('/checkpacking','Webpanel\Order@checkpacking');
		Route::get('/getAverage','Webpanel\Order@getAverage');
		Route::get('/cancel_order','Webpanel\Order@cancel_order');
	});

	Route::prefix('operation')->group(function(){
		Route::get('/','Webpanel\Operation@index');
		Route::get('/{id}','Webpanel\Operation@edit')->where(['id'=>'[0-9]+']);
		Route::get('/check','Webpanel\Operation@check');
		Route::get('/pack','Webpanel\Operation@pack');
		Route::get('/unpack','Webpanel\Operation@unpack');
		Route::get('/confirmPack','Webpanel\Operation@confirmPack');
		Route::get('/oparetion/{id}','Webpanel\PDFController@oparetion');
	});

	Route::prefix('invoice')->group(function(){
		Route::get('/','Webpanel\Invoice@index');
		Route::get('/view/{id}','Webpanel\Invoice@show')->where(['id'=>'[0-9]+']);
		Route::get('/claim/{id}','Webpanel\Invoice@claim')->where(['id'=>'[0-9]+']);
		Route::get('/report/{id}','Webpanel\PDFController@invoice');
		Route::get('/xx_report/{id}','Webpanel\PDFController@xx_invoice');
		Route::get('/getTotal','Webpanel\Invoice@getTotal');
		Route::post('/editTotal','Webpanel\Invoice@editTotal');
		Route::get('/{id}','Webpanel\Invoice@edit')->where(['id'=>'[0-9]+']);
		Route::get('/note/{id}','Webpanel\Invoice@note')  ->where(['id'=>'[0-9]+']);
		Route::post('/note/{id}','Webpanel\Invoice@update_note')  ->where(['id'=>'[0-9]+']);
		Route::post('/{id}',    'Webpanel\Invoice@update')->where(['id'=>'[0-9]+']);
		Route::post('/saveClaim','Webpanel\Invoice@saveClaim');
		
		Route::get('/claims','Webpanel\Invoice@claims');
		Route::get('/claim_detail/{id}','Webpanel\Invoice@claim_detail');
		Route::get('/claim_status/','Webpanel\Invoice@claim_status');

		Route::get('/myClaims','Webpanel\Invoice@myClaims');
		Route::get('/myClaim_detail/{id}','Webpanel\Invoice@myClaim_detail');

		Route::get('/claim_print/{id}','Webpanel\PDFController@claim');

		Route::get('/getUnit','Webpanel\Invoice@getUnit');
		Route::get('/getVal','Webpanel\Invoice@getVal');
		Route::get('/getClearance','Webpanel\Invoice@getClearance');
		Route::get('/getCost','Webpanel\Invoice@getCost');
		Route::get('/getRate','Webpanel\Invoice@getRate');
		Route::get('/getTruck','Webpanel\Invoice@getTruck');

		Route::get('/getITF','Webpanel\Invoice@getITF');
		Route::get('/getShip','Webpanel\Invoice@getShip');
		Route::get('/getAir','Webpanel\Invoice@getAir');
		Route::get('/updateGW','Webpanel\Invoice@updateGW');
		Route::get('/restore/{id}/{row}','Webpanel\Invoice@restore');
		Route::get('/carry','Webpanel\Invoice@carry');
		Route::any('/restore1/','Webpanel\Invoice@restore1');
		
		Route::get('/invoice_report/{id}','Webpanel\PDFController@invoice_report');
		...
		Route::get('/checkpacking','Webpanel\Quotation@checkpacking');
		Route::get('/compareTransport','Webpanel\Quotation@compareTransport');
		Route::post('/combined_payment','Webpanel\Invoice@combined_payment');
		Route::any('/statement','Webpanel\Invoice@statement');
	});


	// Route::prefix('claims')->group(function(){
	// 	Route::get('/','Webpanel\claims@index');
	// 	// Route::get('/view/{id}','Webpanel\claims@show')->where(['id'=>'[0-9]+']);
	// 	// Route::get('/claim/{id}','Webpanel\Invoice@claim')->where(['id'=>'[0-9]+']);
	
	// 	// Route::get('/testpdf','Webpanel\PDFController@testpdf');
	// });
	...
	Route::prefix('menu')->group(function(){
		...
		Route::get('/','Webpanel\Bank@index');
		Route::get('/create','Webpanel\Bank@create');
		Route::put('/create','Webpanel\Bank@store');
		Route::get('/{id}','Webpanel\Bank@edit')->where(['id'=>'[0-9]+']);
		Route::post('/{id}','Webpanel\Bank@update')->where(['id'=>'[0-9]+']);
	
		Route::get('/status/{id}','Webpanel\Bank@status')->where(['id'=>'[0-9]+']);
		Route::get('/delete/{id}','Webpanel\Bank@delete')->where(['id'=>'[0-9]+']);
	});

	/*=============== Hourly Rate ==================*/
	
	Route::prefix('hourlyrate')->group(function(){
		Route::get('/','Webpanel\Hourlyrate@index');
		Route::put('/store','Webpanel\Hourlyrate@store');
		/*Route::get('/create','Webpanel\Item@create');
		Route::put('/create','Webpanel\Item@store');
		Route::get('/{id}','Webpanel\Item@edit')->where(['id'=>'[0-9]+']);
		Route::post('/{id}','Webpanel\Item@update')->where(['id'=>'[0-9]+']);
