...
--
-- Host: localhost
-- Generation Time: Aug 06, 2021 at 10:36 AM
...
INSERT INTO `airline` (`id`, `name`, `airline_code`, `status`, `sort`, `created`, `updated`) VALUES
(1, 'Thai Airways', 'TG', 'on', 2, '2021-03-10 19:01:45', '2021-03-10 19:01:45'),
(2, 'FOB', 'FOB', 'on', 1, '2021-03-10 19:02:31', '2021-03-10 19:02:31');
...
INSERT INTO `airports` (`id`, `country`, `city`, `airport_code`, `status`, `sort`, `created`, `updated`) VALUES
(1, 'Thailand', 'Bangkok', 'BKK', 'on', 1, '2021-03-10 19:02:11', '2021-03-10 19:02:11');

-- --------------------------------------------------------

--
-- Table structure for table `average_lot`
--

CREATE TABLE `average_lot` (
  `id` int(11) NOT NULL,
  `order_id` int(11) DEFAULT NULL,
  `ean_id` int(11) DEFAULT NULL,
  `average` decimal(11,5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `cal_cost`
--

CREATE TABLE `cal_cost` (
  `id` int(11) NOT NULL,
  `itf_id` int(11) DEFAULT NULL,
...
CREATE TABLE `clearance` (
  ...
  `certificate` decimal(10,2) DEFAULT NULL,
  `chamber` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `clearance` (`id`, `vendor`, `charge`, `certificate`, `chamber`, `extras`, `status`, `created`, `updated`) VALUES
(1, 1, '2000.00', '500.00', '500.00', '500.00', 'on', '2021-06-06 07:46:15', '2021-06-06 07:46:15');
...
CREATE TABLE `clients` (
  ...
  `bank_number` int(10) DEFAULT NULL,
  `status` enum('on','off') DEFAULT NULL,
  `sort` int(10) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
...
INSERT INTO `clients` (`id`, `name`, `tax_number`, `email`, `phone`, `address`, `bank_name`, `bank_account`, `bank_number`, `status`, `sort`, `created`, `updated`) VALUES
(1, 'Client', '0123456789123', 'admin@gmail.com', '0987654321', '1\r\n2\r\n3\r\n4\r\n5', NULL, NULL, NULL, 'on', 1, '2021-03-18 20:04:20', '2021-03-18 20:04:20');
...
INSERT INTO `currency` (`id`, `currency`, `status`, `sort`, `created`, `updated`) VALUES
(1, 'THB', 'on', 5, '2020-05-10 23:20:02', '2020-05-10 23:22:31'),
(2, 'USD', 'on', 4, '2020-05-11 09:19:47', '2020-05-11 09:19:47'),
(3, 'EUR', 'on', 3, '2020-05-13 16:56:55', '2020-05-13 16:56:55'),
(4, 'GBP', 'on', 2, '2020-05-13 16:57:05', '2020-05-13 16:57:05');
...
INSERT INTO `district` (`id`, `code`, `name_th`, `name_en`, `_id`) VALUES
...
CREATE TABLE `freight` (
  ...
  `airline` bigint(20) DEFAULT NULL,
  `currency` varchar(255) DEFAULT NULL,
  `rate_45` decimal(10,2) DEFAULT '0.00',
  `rate_100` decimal(10,2) DEFAULT '0.00',
  `rate_250` decimal(10,2) DEFAULT '0.00',
  `rate_500` decimal(10,2) DEFAULT '0.00',
  `rate_1000` decimal(10,2) DEFAULT '0.00',
  `rate_2000` decimal(10,2) DEFAULT '0.00',
  `nego_rate_45` decimal(10,2) DEFAULT '0.00',
  `nego_rate_100` decimal(10,2) DEFAULT '0.00',
  `nego_rate_250` decimal(10,2) DEFAULT '0.00',
  `nego_rate_500` decimal(10,2) DEFAULT '0.00',
  `nego_rate_1000` decimal(10,2) DEFAULT '0.00',
  `nego_rate_2000` decimal(10,2) DEFAULT '0.00',
  `status` enum('on','off') DEFAULT NULL,
  `sort` int(10) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
...
INSERT INTO `freight` (`id`, `vendor`, `destination`, `airline`, `currency`, `rate_45`, `rate_100`, `rate_250`, `rate_500`, `rate_1000`, `rate_2000`, `nego_rate_45`, `nego_rate_100`, `nego_rate_250`, `nego_rate_500`, `nego_rate_1000`, `nego_rate_2000`, `status`, `sort`, `created`, `updated`) VALUES
(1, 1, 1, 1, '1', NULL, NULL, '20.00', '15.00', '10.00', '5.00', NULL, NULL, '20.00', '15.00', '10.00', '5.00', 'on', 2, '2021-06-06 07:45:42', '2021-06-14 18:48:22'),
(2, 1, 1, 2, '1', '0.00', NULL, NULL, NULL, NULL, NULL, '0.00', NULL, NULL, NULL, NULL, NULL, 'on', 1, '2021-06-14 18:56:03', '2021-06-14 18:56:03');
...
INSERT INTO `imports` (`id`, `po`, `type`, `item`, `barcode`, `quantity`, `price`, `unit_count`, `total_price`, `crate`, `confirm`, `confirm_by`, `created`, `updated`) VALUES
(1, 1, 'item', 1, 'PO2021060001001', '2000.00', '20.00', 2, '40000.00', 200, 'yes', 6, NULL, NULL),
(2, 1, 'item', 1, 'PO2021060001002', '200.00', '200.00', 5, '40000.00', 200, 'yes', 6, NULL, NULL),
(3, 1, 'item', 2, 'PO2021060001003', '100.00', '10.00', 1, '1000.00', 10, 'yes', 6, NULL, NULL),
(4, 1, 'boxes', 3, 'PO2021060001004', '5000.00', '20.00', 5, '100000.00', 50, 'yes', 6, NULL, NULL),
(5, 1, 'packaging', 4, 'PO2021060001005', '100000.00', '2.00', 3, '200000.00', 100, 'yes', 6, NULL, NULL),
(6, 1, 'packaging', 5, 'PO2021060001006', '100000.00', '2.00', 4, '200000.00', 100, 'yes', 6, NULL, NULL),
(7, 2, 'item', 1, 'PO2021060002001', '40.00', '400.00', 5, '16000.00', 400, 'yes', 6, NULL, NULL);
...
CREATE TABLE `invoices` (
  ...
  `markup_rate` double DEFAULT NULL,
  `rebate` double DEFAULT NULL,
  `select_pallet` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `select_chamber` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `total_box` double DEFAULT NULL,
  `total_nw` double DEFAULT NULL,
  `total_gw` double DEFAULT NULL,
  `total_cbm` double DEFAULT NULL,
  `palletized` double DEFAULT NULL,
  `palletized_price` double DEFAULT NULL,
  `total_freight` double DEFAULT NULL,
  `total_fob` double DEFAULT NULL,
  `total_pro_before_rebate` double DEFAULT NULL,
  `total_pro_after_rebate` double DEFAULT NULL,
  `total_pro_percent` double DEFAULT NULL,
  `total_package` int(11) DEFAULT NULL,
  `ship_status` enum('pending','carry','shipping','complete') COLLATE utf8_unicode_ci DEFAULT NULL,
  `awb_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `po_number` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `freight_detail` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `etd` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `eta` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `load_date` date DEFAULT NULL,
  `load_time` time DEFAULT NULL,
  `ship_date` date DEFAULT NULL,
  `tt_ref` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `invoices_detail` (
  ...
  `itf_id` bigint(20) DEFAULT NULL,
  `unitcount_id` bigint(20) DEFAULT NULL,
  `qty` double DEFAULT NULL,
  `ean_id` varchar(255) DEFAULT NULL,
  `ean_qty` varchar(255) DEFAULT NULL,
  `net_weight` double DEFAULT NULL,
  `new_weight` double DEFAULT NULL,
  `maxcbm` double DEFAULT NULL,
  `maxpallet` double DEFAULT NULL,
  `average_lot` double DEFAULT NULL,
  `number_box` double DEFAULT NULL,
  `nw` double DEFAULT NULL,
  `gw_weight` double DEFAULT NULL,
  `cbm` double DEFAULT NULL,
  `pallet` double DEFAULT NULL,
  `price_allocation` double DEFAULT NULL,
  `price_pallet_unit` double DEFAULT NULL,
  `itf_pallet_price` decimal(11,4) DEFAULT NULL,
  `itf_clearance_price` decimal(11,4) DEFAULT NULL,
  `itf_transport_price` decimal(11,4) DEFAULT NULL,
  `itf_cost_price` decimal(11,4) DEFAULT NULL,
  `itf_freight_rate` decimal(11,4) DEFAULT NULL,
  `total_itf_cost` decimal(11,4) DEFAULT NULL,
  `unit_price` decimal(11,2) DEFAULT NULL,
  `profit` decimal(11,2) DEFAULT NULL,
  `fob` decimal(11,4) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `items` (
  ...
  `minload` decimal(10,2) DEFAULT '0.00',
  `box_pallet` decimal(10,1) DEFAULT '0.0',
  `cost` decimal(10,2) DEFAULT NULL,
  `unit_cost` decimal(10,2) DEFAULT NULL,
  `wrap_cost` decimal(10,2) DEFAULT NULL,
  `wrap_weight` decimal(10,1) DEFAULT NULL,
...
INSERT INTO `items` (`id`, `type`, `name_th`, `name_en`, `barcode`, `width`, `length`, `height`, `cbm`, `weight`, `minload`, `box_pallet`, `cost`, `unit_cost`, `wrap_cost`, `wrap_weight`, `sort`, `status`, `created`, `updated`, `volume`) VALUES
(1, 'item', 'Dragon Fruit', NULL, 'I0001', NULL, NULL, NULL, '0.0000', NULL, '0.00', '0.0', NULL, NULL, NULL, NULL, 2, 'on', '2021-06-06 07:44:37', '2021-06-06 07:44:37', NULL),
(2, 'item', 'Coconut', NULL, 'I0002', NULL, NULL, NULL, '0.0000', NULL, '0.00', '0.0', NULL, NULL, NULL, NULL, 1, 'on', '2021-06-06 07:44:47', '2021-06-06 07:44:47', NULL),
(3, 'boxes', '1 Kg', NULL, NULL, '27.0', '21.0', '11.0', '0.0062', '190.0', '1.03', '211.0', NULL, NULL, NULL, NULL, NULL, 'on', '2021-06-06 07:46:55', '2021-07-04 09:42:56', NULL),
(4, 'packaging', 'Sleeve 15', NULL, NULL, NULL, NULL, NULL, '0.0000', '1.5', '0.00', '0.0', NULL, NULL, '0.00', '0.0', NULL, 'on', '2021-06-06 07:47:51', '2021-07-04 09:38:37', NULL),
(5, 'packaging', 'Tray 303', NULL, NULL, NULL, NULL, NULL, '0.0000', '2.6', '0.00', '0.0', NULL, NULL, '0.17', '1.2', NULL, 'on', '2021-06-06 07:48:04', '2021-07-04 09:41:40', NULL),
(6, 'pallets', 'Pallets', NULL, NULL, NULL, '0.0', '0.0', '0.0000', '8.5', '0.00', '0.0', '388.95', NULL, NULL, NULL, NULL, 'on', '2021-06-14 13:38:57', '2021-07-08 09:38:21', '0.1800'),
(7, 'packaging', 'Tray 311', NULL, NULL, NULL, NULL, NULL, '0.0000', '2.1', '0.00', '0.0', NULL, NULL, '0.14', '1.0', NULL, 'on', '2021-07-04 09:41:12', NULL, NULL),
(8, 'boxes', '3 Kg', NULL, NULL, '27.0', '40.0', '11.0', '0.0119', '400.0', '1.98', '101.0', NULL, NULL, NULL, NULL, NULL, 'on', '2021-07-04 09:45:36', NULL, NULL);
...
CREATE TABLE `itf` (
  ...
  `all_weight` decimal(10,3) DEFAULT NULL,
  `adjust_weight` decimal(10,0) DEFAULT NULL,
  `new_weight` decimal(10,3) DEFAULT NULL,
  `net_weight` decimal(10,3) DEFAULT NULL,
  `maxcbm` decimal(10,4) DEFAULT NULL,
  `maxminload` decimal(10,2) DEFAULT NULL,
  `maxbox_pallet` int(10) DEFAULT NULL,
  `status` enum('on','off') DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `ean_ppITF` decimal(10,3) NOT NULL DEFAULT '0.000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `itf` (`id`, `code`, `name`, `user`, `all_weight`, `adjust_weight`, `new_weight`, `net_weight`, `maxcbm`, `maxminload`, `maxbox_pallet`, `status`, `created`, `updated`, `ean_ppITF`) VALUES
(1, '1', 'Dragon Fruit - Kg x 10', 6, '10.391', '9', '10.400', '10.000', '0.0062', '1.03', 250, 'on', '2021-06-14 15:41:34', '2021-06-14 15:41:34', '10.000'),
(2, '2', 'Dragon Fruit - 3Kg (8PC)', 6, '3.214', '6', '3.220', '3.000', '0.0062', '1.03', 250, 'on', '2021-06-14 15:43:04', '2021-06-14 15:43:04', '8.000'),
(3, '3', 'Dragon Fruit - 3Kg (9PC)', 6, '3.376', '4', '3.380', '3.000', '0.0062', '1.03', 250, 'on', '2021-06-14 15:44:17', '2021-06-14 15:44:17', '9.000'),
(4, '4', 'Coconut Diamond x 9', 6, '7.429', '1', '7.430', '7.200', '0.0062', '1.03', 250, 'on', '2021-06-18 19:51:22', '2021-06-30 11:43:31', '9.000');

-- --------------------------------------------------------

--
-- Table structure for table `itf_detail`
--

CREATE TABLE `itf_detail` (
  `id` bigint(20) NOT NULL,
  `itf` bigint(20) DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `item` bigint(20) DEFAULT NULL,
  `unit` bigint(20) DEFAULT NULL,
  `qty` decimal(10,2) DEFAULT NULL,
  `ean_qty` decimal(10,0) DEFAULT NULL,
  `cbm` decimal(10,4) DEFAULT NULL,
  `minload` decimal(10,2) DEFAULT NULL,
  `box_pallet` decimal(10,1) DEFAULT NULL,
  `weight` decimal(10,4) DEFAULT NULL,
  `wrap_weight` decimal(10,1) DEFAULT NULL,
  `total_weight` decimal(10,4) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `ean_ppITF` double(10,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `itf_detail`
--

INSERT INTO `itf_detail` (`id`, `itf`, `type`, `item`, `unit`, `qty`, `ean_qty`, `cbm`, `minload`, `box_pallet`, `weight`, `wrap_weight`, `total_weight`, `created`, `updated`, `ean_ppITF`) VALUES
(1, 1, 'ean', 1, 2, '10.00', '1000', '0.0000', '0.00', '0.0', '1024.0000', '0.0', '10240.0000', '2021-06-14 15:41:34', '2021-06-14 15:41:34', 10.00),
(2, 1, 'boxes', 3, NULL, '1.00', '0', '0.0062', '1.03', '250.0', '150.0000', NULL, '150.0000', '2021-06-14 15:41:34', '2021-06-14 15:41:34', 0.00),
(3, 1, 'packaging', 5, NULL, '1.00', '0', '0.0000', '0.00', '0.0', '1.0000', '0.0', '1.0000', '2021-06-14 15:41:34', '2021-06-14 15:41:34', 0.00),
(4, 2, 'ean', 2, NULL, '8.00', '1000', '0.0000', '0.00', '0.0', '1021.0000', '0.0', '3063.0000', '2021-06-14 15:43:04', '2021-06-14 15:43:04', 8.00),
(5, 2, 'boxes', 3, NULL, '1.00', '0', '0.0062', '1.03', '250.0', '150.0000', NULL, '150.0000', '2021-06-14 15:43:04', '2021-06-14 15:43:04', 0.00),
(6, 2, 'packaging', 5, NULL, '1.00', '0', '0.0000', '0.00', '0.0', '1.0000', '0.0', '1.0000', '2021-06-14 15:43:04', '2021-06-14 15:43:04', 0.00),
(7, 3, 'ean', 3, NULL, '9.00', '1000', '0.0000', '0.00', '0.0', '1075.0000', '0.0', '3224.9677', '2021-06-14 15:44:17', '2021-06-14 15:44:17', 9.00),
(8, 3, 'boxes', 3, NULL, '1.00', '0', '0.0062', '1.03', '250.0', '150.0000', NULL, '150.0000', '2021-06-14 15:44:17', '2021-06-14 15:44:17', 0.00),
(9, 3, 'packaging', 5, NULL, '1.00', '0', '0.0000', '0.00', '0.0', '1.0000', '0.0', '1.0000', '2021-06-14 15:44:17', '2021-06-14 15:44:17', 0.00),
(10, 4, 'ean', 4, NULL, '9.00', '1000', '0.0000', '0.00', '0.0', '1011.0000', '0.0', '7279.2000', '2021-06-18 19:51:22', '2021-06-30 11:43:31', 9.00),
(11, 4, 'boxes', 3, NULL, '1.00', '0', '0.0062', '1.03', '250.0', '150.0000', NULL, '150.0000', '2021-06-18 19:51:22', '2021-06-30 11:43:31', 0.00);
...
INSERT INTO `operation` (`id`, `order_id`, `order_detail_id`, `box`, `packaging`, `created`, `updated`) VALUES
(1, 1, 1, NULL, NULL, '2021-07-22 17:31:59', NULL),
(2, 1, 2, NULL, NULL, '2021-07-22 17:31:59', NULL),
(3, 1, 3, NULL, NULL, '2021-07-22 17:31:59', NULL),
(4, 2, 4, NULL, NULL, '2021-07-22 19:07:36', NULL),
(5, 2, 5, NULL, NULL, '2021-07-22 19:07:36', NULL),
(6, 2, 6, NULL, NULL, '2021-07-22 19:07:36', NULL),
(7, 3, 7, NULL, NULL, '2021-07-24 10:29:48', NULL),
(8, 3, 8, NULL, NULL, '2021-07-24 10:29:48', NULL),
(9, 4, 9, NULL, NULL, '2021-07-26 09:31:09', NULL),
(10, 4, 10, NULL, NULL, '2021-07-26 09:31:09', NULL),
(11, 5, 11, NULL, NULL, '2021-07-26 09:58:27', NULL),
(12, 5, 12, NULL, NULL, '2021-07-26 09:58:27', NULL),
(13, 5, 13, NULL, NULL, '2021-07-26 09:58:27', NULL),
(14, 6, 14, NULL, NULL, '2021-07-27 17:19:56', NULL),
(15, 6, 15, NULL, NULL, '2021-07-27 17:19:56', NULL),
(16, 6, 16, NULL, NULL, '2021-07-27 17:19:56', NULL),
(17, 7, 17, NULL, NULL, '2021-07-28 19:27:40', NULL),
(18, 7, 18, NULL, NULL, '2021-07-28 19:27:40', NULL),
(19, 7, 19, NULL, NULL, '2021-07-28 19:27:40', NULL),
(20, 8, 20, NULL, NULL, '2021-07-29 09:00:29', NULL),
(21, 8, 21, NULL, NULL, '2021-07-29 09:00:29', NULL),
(22, 9, 22, NULL, NULL, '2021-07-30 17:19:56', NULL),
(23, 9, 23, NULL, NULL, '2021-07-30 17:19:56', NULL),
(24, 9, 24, NULL, NULL, '2021-07-30 17:19:56', NULL),
(25, 10, 25, NULL, NULL, '2021-08-02 19:09:26', NULL),
(26, 10, 26, NULL, NULL, '2021-08-02 19:09:26', NULL),
(27, 10, 27, NULL, NULL, '2021-08-02 19:09:26', NULL),
(28, 1, 1, NULL, NULL, '2021-08-04 12:01:05', NULL),
(29, 1, 2, NULL, NULL, '2021-08-04 12:01:05', NULL),
(30, 1, 3, NULL, NULL, '2021-08-04 12:01:05', NULL),
(31, 2, 4, NULL, NULL, '2021-08-04 18:14:03', NULL),
(32, 3, 5, NULL, NULL, '2021-08-04 18:46:12', NULL),
(33, 3, 6, NULL, NULL, '2021-08-04 18:46:12', NULL),
(34, 1, 1, NULL, NULL, '2021-08-04 18:50:38', NULL),
(35, 1, 2, NULL, NULL, '2021-08-04 18:50:38', NULL),
(36, 2, 3, NULL, NULL, '2021-08-04 19:25:52', NULL),
(37, 2, 4, NULL, NULL, '2021-08-04 19:25:52', NULL),
(38, 3, 5, NULL, NULL, '2021-08-04 19:25:58', NULL),
(39, 3, 6, NULL, NULL, '2021-08-04 19:25:58', NULL),
(40, 4, 7, NULL, NULL, '2021-08-04 19:26:14', NULL),
(41, 4, 8, NULL, NULL, '2021-08-04 19:26:14', NULL),
(42, 5, 9, NULL, NULL, '2021-08-04 19:26:18', NULL),
(43, 5, 10, NULL, NULL, '2021-08-04 19:26:18', NULL),
(44, 6, 11, NULL, NULL, '2021-08-04 19:26:39', NULL),
(45, 6, 12, NULL, NULL, '2021-08-04 19:26:39', NULL),
(46, 7, 13, NULL, NULL, '2021-08-04 19:30:16', NULL),
(47, 7, 14, NULL, NULL, '2021-08-04 19:30:16', NULL),
(48, 8, 15, NULL, NULL, '2021-08-04 19:33:26', NULL),
(49, 8, 16, NULL, NULL, '2021-08-04 19:33:26', NULL),
(50, 1, 1, NULL, NULL, '2021-08-04 19:37:16', NULL),
(51, 1, 2, NULL, NULL, '2021-08-04 19:37:16', NULL),
(52, 1, 1, NULL, NULL, '2021-08-04 19:40:52', NULL),
(53, 1, 2, NULL, NULL, '2021-08-04 19:40:52', NULL),
(54, 2, 3, NULL, NULL, '2021-08-06 16:59:33', NULL),
(55, 2, 4, NULL, NULL, '2021-08-06 16:59:33', NULL),
(56, 3, 5, NULL, NULL, '2021-08-06 16:59:58', NULL),
(57, 3, 6, NULL, NULL, '2021-08-06 16:59:58', NULL),
(58, 4, 7, NULL, NULL, '2021-08-06 17:01:24', NULL),
(59, 4, 8, NULL, NULL, '2021-08-06 17:01:24', NULL),
(60, 5, 9, NULL, NULL, '2021-08-06 17:04:02', NULL),
(61, 5, 10, NULL, NULL, '2021-08-06 17:04:02', NULL);
...
CREATE TABLE `orders` (
  ...
  `currency_id` bigint(20) DEFAULT NULL,
  `ex_rate` double DEFAULT NULL,
  `markup_rate` double NOT NULL DEFAULT '0',
  `rebate` double NOT NULL DEFAULT '0',
  `select_pallet` varchar(255) DEFAULT NULL,
  `select_chamber` varchar(255) DEFAULT NULL,
  `clearance` double DEFAULT NULL,
  `chamber` double DEFAULT NULL,
  `clearance_price` double DEFAULT NULL,
  `transport` double DEFAULT NULL,
  `transport_price` double DEFAULT NULL,
  `total_box` double DEFAULT NULL,
  `total_nw` double(10,6) DEFAULT NULL,
  `total_gw` double(10,3) DEFAULT NULL,
  `total_cbm` double(10,3) DEFAULT NULL,
  `palletized` double(10,6) DEFAULT NULL,
  `palletized_price` double(10,6) DEFAULT NULL,
  `total_freight` double(10,5) DEFAULT NULL,
  `total_fob` double(10,5) DEFAULT NULL,
  `total_pro_before_rebate` double(10,2) DEFAULT NULL,
  `total_pro_after_rebate` double(10,2) DEFAULT NULL,
  `total_pro_percent` double(10,2) DEFAULT NULL,
  `total_package` int(11) DEFAULT NULL,
  `status` enum('pending','confirm','cancel') DEFAULT NULL,
  `awb_no` varchar(255) DEFAULT NULL,
  `po_number` varchar(255) DEFAULT NULL,
  `freight_detail` varchar(255) DEFAULT NULL,
  `etd` varchar(255) DEFAULT NULL,
  `eta` varchar(255) DEFAULT NULL,
  `load_date` date DEFAULT NULL,
  `load_time` time DEFAULT NULL,
  `ship_date` date DEFAULT NULL,
  `tt_ref` varchar(255) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `total_cnf` decimal(10,2) DEFAULT NULL,
  `markup_rateCal` double(10,4) DEFAULT NULL,
  `freights` double(10,5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orders` (`id`, `quotation_id`, `code`, `inv_no`, `user_id`, `client_id`, `shipto_id`, `airport_id`, `airline_id`, `clearance_id`, `currency_id`, `ex_rate`, `markup_rate`, `rebate`, `select_pallet`, `select_chamber`, `clearance`, `chamber`, `clearance_price`, `transport`, `transport_price`, `total_box`, `total_nw`, `total_gw`, `total_cbm`, `palletized`, `palletized_price`, `total_freight`, `total_fob`, `total_pro_before_rebate`, `total_pro_after_rebate`, `total_pro_percent`, `total_package`, `status`, `awb_no`, `po_number`, `freight_detail`, `etd`, `eta`, `load_date`, `load_time`, `ship_date`, `tt_ref`, `created`, `updated`, `total_cnf`, `markup_rateCal`, `freights`) VALUES
(1, 1, 'O-2021080001', 'INV-2021080001', 12, 1, 1, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', 3500, 500, 1.842105, 2000, 0.526316, 400, 1900.000000, 2023.000, 2.840, 2.000000, 486.187500, 10115.00000, 99535.00000, 16449.80, 13160.30, 12.00, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-04', NULL, '2021-08-04 19:40:52', '2021-08-04 19:40:52', '109.00', 0.1765, 5.00000),
(2, 1, 'O-2021080002', 'INV-2021080001', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', 3500, 500, 1.842105, 2000, 0.526316, 400, 1900.000000, 2023.000, 2.840, 2.000000, 486.187500, 10115.00000, 99535.00000, 16449.80, 13160.30, 12.00, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-04', NULL, '2021-08-06 16:59:33', '2021-08-06 16:59:33', '109.00', 0.1765, 5.00000),
(3, 1, 'O-2021080003', 'INV-2021080001', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', 3500, 500, 1.842105, 2000, 0.526316, 400, 1900.000000, 2023.000, 2.840, 2.000000, 486.187500, 10115.00000, 99535.00000, 16449.80, 13160.30, 12.00, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-04', NULL, '2021-08-06 16:59:58', '2021-08-06 16:59:58', '109.00', 0.1765, 5.00000),
(4, 1, 'O-2021080004', 'INV-2021080001', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', 3500, 500, 1.842105, 2000, 0.526316, 400, 1900.000000, 2023.000, 2.840, 2.000000, 486.187500, 10115.00000, 99535.00000, 16449.80, 13160.30, 12.00, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-04', NULL, '2021-08-06 17:01:24', '2021-08-06 17:01:24', '109.00', 0.1765, 5.00000),
(5, 1, 'O-2021080005', 'INV-2021080001', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', 3500, 500, 1.842105, 2000, 0.526316, 400, 1900.000000, 2023.000, 2.840, 2.000000, 486.187500, 10115.00000, 99535.00000, 16449.80, 13160.30, 12.00, NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-04', NULL, '2021-08-06 17:04:02', '2021-08-06 17:04:02', '109.00', 0.1765, 5.00000);
...
CREATE TABLE `orders_detail` (
  ...
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `profit2` decimal(10,3) NOT NULL DEFAULT '0.000',
  `net_weightNew` decimal(10,2) NOT NULL DEFAULT '0.00',
  `itf_cal_selling` decimal(10,2) NOT NULL DEFAULT '0.00',
  `itf_GW` decimal(10,5) NOT NULL DEFAULT '0.00000',
  `ean_ppITF` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `itfQty` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `net_weight2` decimal(10,6) NOT NULL DEFAULT '0.000000',
  `hpl_avg_weight` decimal(10,6) NOT NULL DEFAULT '0.000000',
  `box_pallet` decimal(10,6) NOT NULL DEFAULT '0.000000',
  `box_weight` decimal(10,6) NOT NULL DEFAULT '0.000000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orders_detail` (`id`, `order_id`, `itf_id`, `unitcount_id`, `qty`, `ean_id`, `ean_qty`, `net_weight`, `new_weight`, `maxcbm`, `maxpallet`, `average_lot`, `number_box`, `nw`, `gw_weight`, `cbm`, `pallet`, `price_allocation`, `price_pallet_unit`, `itf_pallet_price`, `itf_clearance_price`, `itf_transport_price`, `itf_cost_price`, `itf_freight_rate`, `total_itf_cost`, `unit_price`, `profit`, `fob`, `created`, `updated`, `profit2`, `net_weightNew`, `itf_cal_selling`, `itf_GW`, `ean_ppITF`, `itfQty`, `net_weight2`, `hpl_avg_weight`, `box_pallet`, `box_weight`) VALUES
(1, 1, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, NULL, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, '194.4750', '1842.1053', '526.3158', '58.2670', '5221.2500', NULL, '18.43', '12.01', NULL, '2021-08-04 19:40:52', '2021-08-04 19:40:52', '9.990', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(2, 1, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, NULL, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, '583.4250', '1657.8947', '473.6842', '57.2670', '4893.7500', NULL, '6.04', '12.00', NULL, '2021-08-04 19:40:52', '2021-08-04 19:40:52', '9.990', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(3, 2, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, NULL, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, '194.4750', '1842.1053', '526.3158', '58.2670', '5221.2500', NULL, '18.43', '12.01', NULL, '2021-08-06 16:59:33', '2021-08-06 16:59:33', '9.990', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(4, 2, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, NULL, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, '583.4250', '1657.8947', '473.6842', '57.2670', '4893.7500', NULL, '6.04', '12.00', NULL, '2021-08-06 16:59:33', '2021-08-06 16:59:33', '9.990', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(5, 3, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, NULL, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, '194.4750', '1842.1053', '526.3158', '58.2670', '5221.2500', NULL, '18.43', '12.01', NULL, '2021-08-06 16:59:58', '2021-08-06 16:59:58', '9.990', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(6, 3, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, NULL, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, '583.4250', '1657.8947', '473.6842', '57.2670', '4893.7500', NULL, '6.04', '12.00', NULL, '2021-08-06 16:59:58', '2021-08-06 16:59:58', '9.990', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(7, 4, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, NULL, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, '194.4750', '1842.1053', '526.3158', '58.2670', '5221.2500', NULL, '18.43', '12.01', NULL, '2021-08-06 17:01:24', '2021-08-06 17:01:24', '9.990', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(8, 4, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, NULL, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, '583.4250', '1657.8947', '473.6842', '57.2670', '4893.7500', NULL, '6.04', '12.00', NULL, '2021-08-06 17:01:24', '2021-08-06 17:01:24', '9.990', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(9, 5, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, NULL, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, '194.4750', '1842.1053', '526.3158', '58.2670', '5221.2500', NULL, '18.43', '12.01', NULL, '2021-08-06 17:04:02', '2021-08-06 17:04:02', '9.990', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(10, 5, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, NULL, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, '583.4250', '1657.8947', '473.6842', '57.2670', '4893.7500', NULL, '6.04', '12.00', NULL, '2021-08-06 17:04:02', '2021-08-06 17:04:02', '9.990', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000');
...
CREATE TABLE `packing` (
  ...
  `number_staff` int(10) DEFAULT NULL,
  `qty` decimal(10,2) DEFAULT NULL,
  `packing_date` date DEFAULT NULL,
  `sorting_id` bigint(20) DEFAULT NULL,
  `sorting_qty` decimal(10,2) DEFAULT NULL,
  `item` bigint(20) DEFAULT NULL,
  `unit` bigint(20) DEFAULT NULL,
  `cost_asl` decimal(10,2) DEFAULT NULL,
  `po_price` decimal(10,2) DEFAULT NULL,
  `wastage` decimal(10,3) DEFAULT NULL,
  `wastage_weight` decimal(10,4) DEFAULT NULL,
  `wastage_percent` decimal(10,3) DEFAULT NULL,
  `cost` decimal(10,2) DEFAULT NULL,
  `ean_cost` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `packing` (`id`, `start`, `finish`, `number_staff`, `qty`, `packing_date`, `sorting_id`, `sorting_qty`, `item`, `unit`, `cost_asl`, `po_price`, `wastage`, `wastage_weight`, `wastage_percent`, `cost`, `ean_cost`, `wages`, `status`, `created`, `updated`) VALUES
(25, '22:00:00', '23:00:00', 1, '900.00', '2021-06-23', 2, '1600.00', 1, 2, '22.22', NULL, '0.629', '566.2500', '0.629', '0.00', '0.00', '0.00', 'on', '2021-06-23 18:39:04', '2021-06-23 18:39:04'),
(30, '23:00:00', '12:00:00', 1, '300.00', '2021-06-28', 4, '320.00', 1, 2, '50.00', NULL, '0.614', '184.2500', '0.614', '0.00', '0.00', '0.00', 'on', '2021-06-28 12:58:53', '2021-06-28 12:58:53'),
(43, '22:00:00', '23:00:00', 1, '1600.00', '2021-07-02', 2, '1600.00', 1, 2, '22.22', NULL, '0.750', '1200.0000', '0.750', '0.00', '0.00', '0.00', 'on', '2021-07-02 13:01:51', '2021-07-02 13:01:51'),
(46, '00:00:00', '01:30:00', 10, '1600.00', '2021-07-02', 3, '1600.00', 1, 2, '25.00', NULL, '0.063', '100.0000', '0.063', '0.00', '0.00', '0.00', 'on', '2021-07-02 15:30:45', '2021-07-02 15:30:45'),
(47, '00:00:00', '01:30:00', 1, '90.00', '2021-07-02', 1, '90.00', 2, 1, '11.11', NULL, '0.111', '10.0000', '0.111', '0.00', '0.00', '0.00', 'on', '2021-07-02 17:42:31', '2021-07-02 17:42:31');
...
CREATE TABLE `packing_detail` (
  `id` bigint(20) NOT NULL,
  `packing` bigint(20) DEFAULT NULL,
  `product` bigint(20) DEFAULT NULL,
  `number_pack` int(10) DEFAULT NULL,
  `product_weight` decimal(10,4) DEFAULT NULL,
  `cost_packaging` decimal(10,2) DEFAULT NULL,
  `qty_packaging` int(11) DEFAULT NULL,
  `wrap_cost` decimal(10,2) DEFAULT NULL,
  `plus_cost` decimal(10,2) DEFAULT NULL COMMENT 'cost_packaging + wrap_cost',
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `balance` int(10) DEFAULT NULL,
  `cal_balance` double DEFAULT NULL,
  `ean_unit` int(11) NOT NULL,
  `cost_ean` double(10,3) NOT NULL DEFAULT '0.000',
  `ean_uc` decimal(10,3) NOT NULL DEFAULT '0.000',
  `ean_uw` decimal(10,3) NOT NULL DEFAULT '0.000',
  `net_weight` double(10,4) NOT NULL DEFAULT '0.0000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `packing_detail` (`id`, `packing`, `product`, `number_pack`, `product_weight`, `cost_packaging`, `qty_packaging`, `wrap_cost`, `plus_cost`, `created`, `updated`, `balance`, `cal_balance`, `ean_unit`, `cost_ean`, `ean_uc`, `ean_uw`, `net_weight`) VALUES
(95, 43, 3, 1200, '1.0000', '11.00', NULL, '3.00', NULL, '2021-07-02 13:01:51', '2021-07-02 13:01:51', 1200, NULL, 1, 40.677, '122.030', '400.000', 333.3333),
(100, 46, 1, 500, '1.0000', '9.00', 500, '3.00', NULL, '2021-07-02 15:30:45', '2021-07-02 15:30:45', 500, 500, 2, 36.267, '36.267', '500.000', 1000.0000),
(101, 46, 2, 500, '1.0000', '8.00', 500, '1.00', NULL, '2021-07-02 15:30:45', '2021-07-02 15:30:45', 500, 500, 2, 35.267, '35.267', '500.000', 375.0000),
(102, 46, 3, 1500, '1.0000', '11.00', 1500, '3.00', NULL, '2021-07-02 15:30:45', '2021-07-02 15:30:45', 1500, 1500, 1, 20.089, '60.267', '500.000', 333.3333),
(103, 47, 4, 40, '1.0000', '5.00', 40, '1.00', NULL, '2021-07-02 17:42:31', '2021-07-02 17:42:31', 40, 40, 1, 18.624, '20.693', '40.000', 900.0000),
(104, 47, 4, 36, '1.0000', '5.56', 36, '1.00', NULL, '2021-07-02 17:42:31', '2021-07-02 17:42:31', 36, 36, 2, 20.698, '20.698', '40.000', 900.0000);
...
CREATE TABLE `pos` (
  ...
  `user` bigint(20) DEFAULT NULL,
  `vendor` bigint(20) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL COMMENT '1 = pending,2 = pickup,3 = delivery,4 = receive,5 = cancel',
  `paid` varchar(255) DEFAULT NULL COMMENT '1 = notpaid, 2 = paid, 3 = cancel',
  `staff_press` int(11) DEFAULT NULL,
...
INSERT INTO `pos` (`id`, `code`, `user`, `vendor`, `status`, `paid`, `staff_press`, `paid_date`, `paid_by`, `staff_name`, `created`, `updated`, `pickup_date`, `delivery_date`, `receive_date`, `return_date`) VALUES
(1, 'PO2021060001', 6, 1, 'receive', 'notpaid', NULL, NULL, NULL, NULL, '2021-06-06 07:50:45', NULL, NULL, '2021-06-06 07:52:43', '2021-06-14 15:47:57', NULL),
(2, 'PO2021060002', 6, 1, 'receive', 'notpaid', NULL, NULL, NULL, NULL, '2021-06-15 09:32:50', NULL, NULL, '2021-06-15 09:33:06', '2021-06-15 09:33:40', NULL);
...
INSERT INTO `products` (`id`, `code`, `name`, `user`, `total_weight`, `total_qty`, `status`, `created`, `updated`) VALUES
(1, '1', 'Dragon Fruit - Kg', 6, '1.024', 1000, 'on', '2021-06-06 08:08:17', '2021-06-21 12:07:04'),
(2, '2', 'Dragon Fruit - 8Pc (3KG)', 6, '1.021', 1000, 'on', '2021-06-06 08:09:18', '2021-06-06 08:23:25'),
(3, '3', 'Dragon Fruit - 9Pc (3KG)', 6, '1.075', 1000, 'on', '2021-06-06 08:11:43', '2021-06-21 17:16:32'),
(4, '4', 'Coconut Diamond', 6, '1.011', 1000, 'on', '2021-06-06 08:12:51', '2021-06-06 08:12:51');
...
INSERT INTO `provinces` (`id`, `code`, `name_th`, `name_en`, `_id`) VALUES
...
CREATE TABLE `quotations` (
  ...
  `select_pallet` varchar(255) DEFAULT NULL,
  `select_chamber` varchar(255) DEFAULT NULL,
  `clearance` decimal(10,6) DEFAULT NULL,
  `chamber` decimal(10,6) DEFAULT NULL,
  `clearance_price` decimal(10,6) DEFAULT NULL,
  `transport` decimal(10,6) DEFAULT NULL,
  `transport_price` decimal(10,6) DEFAULT NULL,
  `total_box` double DEFAULT NULL,
  `total_nw` decimal(10,6) DEFAULT NULL,
  `total_gw` decimal(10,3) DEFAULT NULL,
  `total_cbm` decimal(10,3) DEFAULT NULL,
  `palletized` decimal(10,6) DEFAULT NULL,
  `palletized_price` decimal(10,6) DEFAULT NULL,
  `total_freight` decimal(10,5) DEFAULT NULL,
  `total_fob` decimal(11,5) DEFAULT '0.00000',
  `total_pro_before_rebate` decimal(10,2) DEFAULT NULL,
  `total_pro_after_rebate` decimal(10,2) DEFAULT NULL,
  `total_pro_percent` decimal(10,2) DEFAULT NULL,
  `status` enum('pending','approve','cancel') DEFAULT NULL,
  `ship_date` date DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `total_cnf` decimal(10,2) NOT NULL DEFAULT '0.00',
  `markup_rateCal` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `freights` decimal(10,5) NOT NULL DEFAULT '0.00000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `quotations` (`id`, `code`, `user_id`, `client_id`, `shipto_id`, `airport_id`, `airline_id`, `clearance_id`, `currency_id`, `ex_rate`, `markup_rate`, `rebate`, `select_pallet`, `select_chamber`, `clearance`, `chamber`, `clearance_price`, `transport`, `transport_price`, `total_box`, `total_nw`, `total_gw`, `total_cbm`, `palletized`, `palletized_price`, `total_freight`, `total_fob`, `total_pro_before_rebate`, `total_pro_after_rebate`, `total_pro_percent`, `status`, `ship_date`, `created`, `updated`, `total_cnf`, `markup_rateCal`, `freights`) VALUES
(1, 'Q-2021080001', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', '3500.000000', '500.000000', '1.842105', '2000.000000', '0.526316', 400, '1900.000000', '2023.000', '2.840', '2.000000', '486.187500', '10115.00000', '99535.00000', '16449.80', '13160.30', '12.00', 'approve', '2021-08-04', '2021-08-04 19:40:40', '2021-08-04 19:40:40', '109.00', '0.1765', '5.00000'),
(2, 'Q-2021080002', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', '3500.000000', '500.000000', '1.842105', '2000.000000', '0.526316', 400, '1900.000000', '2023.000', '2.840', '2.000000', '486.187500', '10115.00000', '99535.00000', '16449.80', '13160.30', '12.00', 'pending', '2021-08-04', '2021-08-06 17:12:52', '2021-08-06 17:12:52', '109.00', '0.1765', '5.00000'),
(3, 'Q-2021080003', 12, 1, NULL, 1, 1, 1, 1, 30, 15, 3, 'yes', 'yes', '3500.000000', '500.000000', '1.842105', '2000.000000', '0.526316', 400, '1900.000000', '2023.000', '2.840', '2.000000', '486.187500', '10115.00000', '99535.00000', '16449.80', '13160.30', '12.00', 'pending', '2021-08-04', '2021-08-06 17:26:08', '2021-08-06 17:26:35', '109.00', '0.1765', '5.00000');
...
CREATE TABLE `quotations_detail` (
  ...
  `price_allocation` double DEFAULT NULL,
  `price_pallet_unit` double DEFAULT NULL,
  `itf_pallet_price` double DEFAULT NULL,
  `itf_clearance_price` double DEFAULT NULL,
  `itf_transport_price` double DEFAULT NULL,
  `itf_cost_price` double DEFAULT NULL,
  `itf_freight_rate` double DEFAULT NULL,
  `total_itf_cost` double DEFAULT NULL,
  `unit_price` double DEFAULT NULL,
  `profit` double DEFAULT NULL,
  `fob` double DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `profit2` decimal(3,2) NOT NULL,
  `net_weightNew` decimal(10,2) NOT NULL,
  `itf_cal_selling` decimal(10,2) DEFAULT '0.00',
  `itf_GW` decimal(10,5) NOT NULL DEFAULT '0.00000',
  `ean_ppITF` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `itfQty` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `net_weight2` decimal(10,6) NOT NULL DEFAULT '0.000000',
...
INSERT INTO `quotations_detail` (`id`, `quotation_id`, `itf_id`, `unitcount_id`, `qty`, `ean_id`, `ean_qty`, `net_weight`, `new_weight`, `maxcbm`, `maxpallet`, `number_box`, `nw`, `gw_weight`, `cbm`, `pallet`, `price_allocation`, `price_pallet_unit`, `itf_pallet_price`, `itf_clearance_price`, `itf_transport_price`, `itf_cost_price`, `itf_freight_rate`, `total_itf_cost`, `unit_price`, `profit`, `fob`, `created`, `updated`, `profit2`, `net_weightNew`, `itf_cal_selling`, `itf_GW`, `ean_ppITF`, `itfQty`, `net_weight2`, `hpl_avg_weight`, `box_pallet`, `box_weight`) VALUES
(1, 1, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, 194.475, 1842.10526, 526.3158, 58.267, 5221.25, NULL, 18.43, 12.01, NULL, '2021-08-04 19:40:40', '2021-08-04 19:40:40', '9.99', '10.00', '552.85', '1042.12500', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(2, 1, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, 583.425, 1657.89474, 473.6842, 57.267, 4893.75, NULL, 6.04, 12, NULL, '2021-08-04 19:40:40', '2021-08-04 19:40:40', '9.99', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(3, 2, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, 194.475, 1842.10526, 526.3158, 58.267, 5221.25, NULL, 18.43, 12.01, NULL, '2021-08-06 17:12:52', '2021-08-06 17:12:52', '9.99', '10.00', '552.85', '1040.00000', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(4, 2, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, 583.425, 1657.89474, 473.6842, 57.267, 4893.75, NULL, 6.04, 12, NULL, '2021-08-06 17:12:52', '2021-08-06 17:12:52', '9.99', '3.00', '181.21', '966.00000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000'),
(5, 3, 1, 5, 100, '1', '10.00', 10, 10.4, 0.0062, 250, 100, 1000, 1044.25, 0.62, 0.4, 389, 3.89, 194.475, 1842.10526, 526.3158, 58.267, 5221.25, NULL, 18.43, 12.01, NULL, '2021-08-06 17:26:08', '2021-08-06 17:26:36', '9.99', '10.00', '552.85', '1044.25000', '10.0000', '12.0000', '1000.000000', '1000.000000', '250.000000', '10.400000'),
(6, 3, 2, 5, 300, '2', '8.00', 3, 3.22, 0.0062, 250, 300, 900, 978.75, 1.86, 1.2, 584, 1.9467, 583.425, 1657.89474, 473.6842, 57.267, 4893.75, NULL, 6.04, 12, NULL, '2021-08-06 17:26:08', '2021-08-06 17:26:36', '9.99', '3.00', '181.21', '978.75000', '8.0000', '10.0000', '900.000000', '375.000000', '250.000000', '3.220000');
...
CREATE TABLE `receiving` (
  ...
  `item` bigint(20) DEFAULT NULL,
  `unit` bigint(20) DEFAULT NULL,
  `num_crate` int(11) DEFAULT NULL,
  `num_qty` decimal(10,2) DEFAULT NULL,
  `transection_type` varchar(255) DEFAULT NULL,
  `average_weight` decimal(10,4) DEFAULT NULL,
  `receive_date` datetime DEFAULT NULL,
  `total_weight` decimal(10,2) DEFAULT NULL,
  `sorting` enum('no','yes') DEFAULT NULL,
  `sorting_by` bigint(20) DEFAULT NULL,
  `balance` decimal(10,2) DEFAULT NULL,
  `cal_balance` double DEFAULT NULL,
  `receiving_cost` decimal(10,2) NOT NULL DEFAULT '0.00',
  `isBox` char(3) NOT NULL DEFAULT 'no',
  `transactionValue` float(10,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `receiving` (`id`, `po`, `import`, `code`, `type`, `item`, `unit`, `num_crate`, `num_qty`, `transection_type`, `average_weight`, `receive_date`, `total_weight`, `sorting`, `sorting_by`, `balance`, `cal_balance`, `receiving_cost`, `isBox`, `transactionValue`) VALUES
(1, 1, 5, 'PO2021060001005', 'packaging', 4, 3, NULL, '100000.00', 'buy', NULL, '2021-06-06 07:53:14', NULL, NULL, NULL, '100000.00', 100000, '2.00', 'no', 200000.00),
(2, 1, 3, 'PO2021060001003', 'item', 2, 1, 10, '100.00', 'buy', '0.9000', '2021-06-06 07:55:15', '89.10', 'yes', 6, NULL, NULL, '10.00', 'no', 1000.00),
(3, 1, 1, 'PO2021060001001', 'item', 1, 2, 200, '2000.00', 'buy', '1.0000', '2021-06-06 07:56:20', '1999.00', 'yes', 6, NULL, NULL, '20.00', 'no', 40000.00),
(4, 1, 2, 'PO2021060001002', 'item', 1, 2, 200, '200.00', 'buy', '1.0000', '2021-06-06 07:56:41', '2000.00', 'yes', 6, NULL, NULL, '20.00', 'yes', 40000.00),
(5, 1, 6, 'PO2021060001006', 'packaging', 5, 4, NULL, '100000.00', 'buy', NULL, '2021-06-06 13:51:40', NULL, NULL, NULL, '100000.00', 100000, '2.00', 'no', 200000.00),
(6, 1, 4, 'PO2021060001004', 'boxes', 3, 5, NULL, '5000.00', 'buy', NULL, '2021-06-14 15:47:57', NULL, NULL, NULL, '5000.00', 5000, '20.00', 'no', 100000.00),
(7, 2, 7, 'PO2021060002001', 'item', 1, 2, 40, '40.00', 'buy', '1.0000', '2021-06-15 09:33:40', '400.00', 'yes', 6, NULL, NULL, '40.00', 'yes', 16000.00);
...
CREATE TABLE `setups` (
  ...
  `product` bigint(20) DEFAULT NULL,
  `avg_weight` decimal(10,4) DEFAULT NULL COMMENT 'estimtaed weights(g)',
  `weight` decimal(10,1) DEFAULT NULL COMMENT 'g',
  `wrap_weight` decimal(10,1) DEFAULT NULL COMMENT 'g',
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `setups` (`id`, `type`, `item`, `unit`, `qty`, `product`, `avg_weight`, `weight`, `wrap_weight`, `created`, `updated`) VALUES
(1, 'item', 1, 2, '1000.0000', 1, '1.0000', NULL, NULL, '2021-06-06 08:08:17', '2021-06-21 12:07:04'),
(2, 'packaging', 4, 1, '3.0000', 1, '1.0000', '5.0', '3.0', '2021-06-06 08:08:17', '2021-06-21 12:07:04'),
(3, 'item', 1, 2, '375.0000', 2, '2.6667', NULL, NULL, '2021-06-06 08:09:18', '2021-06-06 08:23:25'),
(4, 'packaging', 4, NULL, '1.0000', 2, '1.0000', '5.0', '3.0', '2021-06-06 08:09:18', '2021-06-06 08:23:25'),
(6, 'item', 1, 2, '333.3333', 3, '3.0000', NULL, NULL, '2021-06-06 08:11:43', '2021-06-21 17:16:32'),
(7, 'packaging', 4, NULL, '3.0000', 3, '1.0000', '5.0', '3.0', '2021-06-06 08:11:43', '2021-06-21 17:16:32'),
(8, 'item', 2, 2, '800.0000', 4, '1.2500', NULL, NULL, '2021-06-06 08:12:51', '2021-06-06 08:12:51'),
(9, 'packaging', 4, NULL, '1.0000', 4, '1.0000', '5.0', '3.0', '2021-06-06 08:12:51', '2021-06-06 08:12:51'),
(10, 'packaging', 5, NULL, '1.0000', 4, '1.0000', '1.0', '0.0', '2021-06-06 08:12:51', '2021-06-06 08:12:51'),
(11, 'packaging', 5, NULL, '1.0000', 3, '1.0000', '1.0', '0.0', '2021-06-06 08:22:54', '2021-06-21 17:16:32');

-- --------------------------------------------------------

--
-- Table structure for table `shiptos`
--
...
CREATE TABLE `shiptos` (
  ...
  `phone` varchar(255) DEFAULT NULL,
  `address` text,
  `airport` bigint(20) DEFAULT NULL,
  `notify_name` varchar(255) DEFAULT NULL,
  `notify_tax_number` int(10) DEFAULT NULL,
  `notify_email` varchar(255) DEFAULT NULL,
  `notify_phone` varchar(255) DEFAULT NULL,
  `notify_address` text,
  `status` enum('on','off') DEFAULT NULL,
  `sort` int(10) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
--
-- Dumping data for table `shiptos`
--

INSERT INTO `shiptos` (`id`, `client`, `name`, `tax_number`, `email`, `phone`, `address`, `airport`, `notify_name`, `notify_tax_number`, `notify_email`, `notify_phone`, `notify_address`, `status`, `sort`, `created`, `updated`) VALUES
(1, 1, 'Sudhir Mandal', 3545634, 'sudhir1994php@gmail.com', '8409243393', 'Noida sector 15, Uttar Pradesh  India-201301', 1, 'Mobapps', 2147483647, 'sl@gmail.com', '7992377284', 'Noida sector 15, Uttar Pradesh  India-201301', 'on', 1, '2021-04-05 17:42:34', '2021-06-04 13:21:20');
...
CREATE TABLE `sorting` (
  ...
  `unit` bigint(20) DEFAULT NULL,
  `num_qty` decimal(10,2) DEFAULT NULL,
  `waste_qty` decimal(11,2) DEFAULT NULL,
  `blue_crate` int(11) DEFAULT NULL,
  `note` text,
  `avg_weight` decimal(10,4) DEFAULT NULL,
  `sorting_date` datetime DEFAULT NULL,
  `total_price` decimal(10,2) DEFAULT NULL,
  `transection_type` varchar(255) DEFAULT NULL,
  `status` enum('on','off') DEFAULT 'on',
  `packing` enum('no','yes') DEFAULT NULL,
...
INSERT INTO `sorting` (`id`, `receive`, `code`, `type`, `item`, `unit`, `num_qty`, `waste_qty`, `blue_crate`, `note`, `avg_weight`, `sorting_date`, `total_price`, `transection_type`, `status`, `packing`, `packing_date`, `balance`, `isBox`) VALUES
(1, 2, 'PO2021060001003', 'item', 2, 1, '90.00', '10.00', 10, NULL, '0.9000', '2021-06-06 07:57:45', '11.11', 'waste', 'on', 'yes', '2021-07-02 17:42:31', '0.00', 'no'),
(2, 3, 'PO2021060001001', 'item', 1, 2, '1800.00', '200.00', 180, NULL, '1.0000', '2021-06-06 07:58:57', '22.22', 'waste', 'on', 'yes', '2021-07-02 13:01:51', '0.00', 'no'),
(3, 4, 'PO2021060001002', 'item', 1, 2, '1600.00', '400.00', 18, NULL, '1.0000', '2021-06-06 07:59:45', '25.00', 'waste', 'on', 'yes', '2021-07-02 15:30:45', '0.00', 'yes'),
(4, 7, 'PO2021060002001', 'item', 1, 2, '320.00', '80.00', 30, NULL, '1.0000', '2021-06-15 09:35:05', '50.00', 'waste', 'on', 'no', NULL, '320.00', 'yes');
...
INSERT INTO `sub-district` (`id`, `zipcode`, `name_th`, `name_en`, `_id`) VALUES
...
('100205', 10300, '*บางซื่อ   ', '*Bang Sue', 2),
('100206', 10300, 'ถนนนครไชยศรี   ', 'Thanon Nakhon Chai Si', 2),
('100299', 10300, '*สามเสนใน   ', '*Sam Sen Nai', 2),
...
('100501', 10220, '*ลาดยาว', '*Lad Yao', 5),
('100502', 10220, 'อนุสาวรีย์   ', 'Anusawari', 5),
('100503', 10220, 'คลองถนน*   ', 'Khlong Thanon*', 5),
('100504', 10220, '*ตลาดบางเขน   ', '*Talad Bang Khen', 5),
('100505', 10220, '*สีกัน', '*See Kan', 5),
('100506', 10220, 'สายไหม*   ', 'Sai Mai*', 5),
('100507', 10220, '*ทุ่งสองห้อง', '*Thung Song Hong', 5),
('100508', 10220, 'ท่าแร้ง   ', 'Tha Raeng', 5),
('100509', 10220, 'ออเงิน*   ', 'Or Ngern*', 5),
('100599', 10220, '*บางเขน   ', '*Bang Khen', 5),
('100601', 10240, 'คลองจั่น   ', 'Khlong Chan', 6),
('100602', 10240, 'วังทองหลาง*   ', 'Wang Thong Lang*', 6),
('100603', 10240, '*ลาดพร้าว', '*Lad Prao', 6),
('100604', 10240, '*คลองกุ่ม', '*Klong Khum', 6),
('100605', 10240, '*สะพานสูง', '*Saphan Sung', 6),
('100606', 10240, '*คันนายาว   ', '*Khan Na Yao', 6),
('100607', 10240, '*จรเข้บัว', '*Chorakhe Bua', 6),
...
('100899', 10100, '*นางเลิ้ง', '*Nang Lerng', 8),
('100901', 10260, '*คลองเตย', '*Khlong Toei', 9),
('100902', 10260, '*คลองตัน   ', '*Khlong Ton', 9),
('100903', 10260, '*พระโขนง   ', '*Phra Kha Nong', 9),
('100904', 10260, 'บางนา*   ', 'Ban Na*', 9),
('100905', 10260, 'บางจาก   ', 'Bang Chak', 9),
('100906', 10260, '*สวนหลวง   ', '*Suan Luang', 9),
('100907', 10260, '*หนองบอน   ', '*Nong Bon', 9),
('100908', 10260, '*ประเวศ   ', '*Prawet', 9),
('100909', 10260, '*ดอกไม้   ', '*Dok Mai', 9),
('100997', 10260, '*พระโขนง   ', '*Phra Kha Nong', 9),
('100998', 10260, '*คลองตัน   ', '*Khlong Ton', 9),
('100999', 10260, '*คลองเตย   ', '*Khlong Toei', 9),
('101001', 10510, 'มีนบุรี   ', 'Min Buri', 10),
('101002', 10510, 'แสนแสบ   ', 'Saen Saep', 10),
('101003', 10510, 'บางชัน*   ', 'Bang Chan*', 10),
('101004', 10510, 'ทรายกองดิน*   ', 'Sai Kong Din*', 10),
('101005', 10510, 'ทรายกองดินใต้*   ', 'Sai Kong Din Tai*', 10),
('101006', 10510, 'สามวาตะวันออก*   ', 'Sam Wa Ta Wan Ook*', 10),
('101007', 10510, 'สามวาตะวันตก*   ', 'Sam Wa Ta Wan Tok*', 10),
...
('101201', 10120, '*ทุ่งวัดดอน   ', '*Thung Wat Don', 12),
('101202', 10120, '*ยานนาวา   ', '*Yan Nawa', 12),
('101203', 10120, 'ช่องนนทรี   ', 'Chong Nonsi', 12),
('101204', 10120, 'บางโพงพาง   ', 'Bang Phongphang', 12),
('101205', 10120, '*วัดพระยาไกร   ', '*Pra Ya Krai', 12),
('101206', 10120, '*บางโคล่   ', '*Bang Khlo', 12),
('101207', 10120, '*บางคอแหลม   ', '*Bang Kho Laem', 12),
('101208', 10120, '*ทุ่งมหาเมฆ   ', '*Tung Ma Ha Mek', 12),
('101298', 10120, '*บางโคล่   ', '*Bang Khlo', 12),
('101299', 10120, '*บางคอแหลม   ', '*Bang Kho Laem', 12),
...
('101402', 10400, '*ถนนเพชรบุรี   ', '*Thanon Phetchaburi', 14),
('101403', 10400, '*ทุ่งพญาไท   ', '*Thung Phaya Thai', 14),
('101404', 10400, '*มักกะสัน   ', '*Makkasan', 14),
('101405', 10400, '*ถนนพญาไท   ', '*Thanon Phaya Thai', 14),
('101499', 10400, '*ทุ่งพญาไท   ', '*Thung Phaya Thai', 14),
...
('101599', 10600, '*คลองสาน   ', '*Klong Sarn', 15),
...
('101703', 10310, '*ดินแดง   ', '*Din Dang', 17),
...
('101906', 10170, 'ทวีวัฒนา*   ', 'Thawi Watthana*', 19),
('101907', 10170, 'บางเชือกหนัง   ', 'Bang Chueak Nang', 19),
('101908', 10170, 'ศาลาธรรมสพน์*   ', 'Sala Thammasop*', 19),
('102001', 10700, '*บางพลัด   ', '*Bang Phlat', 20),
('102002', 10700, '*บางบำหรุ   ', '*Bang Bumru', 20),
('102003', 10700, '*บางอ้อ   ', '*Bang Aor', 20),
...
('102008', 10700, '*บางยี่ขัน   ', '*Bang Yikhan', 20),
('102009', 10700, 'อรุณอมรินทร์   ', 'Arun Ammarin', 20),
('102097', 10700, '*บางยี่ขัน   ', '*Bang Yikhan', 20),
('102098', 10700, '*บางบำหรุ   ', '*Bang Bumru', 20),
('102099', 10700, '*บางอ้อ   ', '*Bang Aor', 20),
('102101', 10150, '*บางค้อ   ', '*Bang Kho', 21),
('102102', 10150, '*จอมทอง   ', '*Chom Thong', 21),
('102103', 10150, '*บางขุนเทียน   ', '*Bang Khun Thian', 21),
('102104', 10150, 'บางบอน*   ', 'Bang Bon*', 21),
('102105', 10150, 'ท่าข้าม   ', 'Tha Kham', 21),
('102106', 10150, '*บางมด   ', '*Bang Mod', 21),
...
('102301', 10160, 'หลักสอง*   ', 'Lak Song*', 23),
...
('103601', 10210, 'ตลาดบางเขน*   ', 'Bang Khen Market*', 36),
('103602', 10210, 'สีกัน   ', 'Si Kan', 36),
('103603', 10210, 'ทุ่งสองห้อง*   ', 'Thung Song Hong *', 36),
...
('110105', 10280, '*นาเกลือ   ', '*Na Klua', 52),
('110106', 10280, '*แหลมฟ้าผ่า   ', '*Laem Khapa', 52),
('110107', 10280, '*ในคลองบางปลากด   ', '*Nai Klong Pla Kod', 52),
('110108', 10280, 'บางปูใหม่   ', 'Bang Pu Mai', 52),
('110109', 10280, '*ปากคลองบางปลากด   ', '*Pak Klong Pa Kod', 52),
...
('110194', 10280, '*บางปูเก่า   ', '*Bang Poo', 52),
('110195', 10280, '*ในคลองบางปลากด   ', '*Nai Klong Pla Kod', 52),
('110196', 10280, '*ปากคลองบางปลากด   ', '*Pak Klong Pa Kod', 52),
('110197', 10280, '*แหลมฟ้าผ่า   ', '*Laem Khapa', 52),
('110198', 10280, '*บ้านคลองสวน   ', '*Ban Klong Suan', 52),
('110199', 10280, '*นาเกลือ   ', '*Na Klua', 52),
...
('110209', 10560, 'คลองนิยม*   ', 'Klong Niyom*', 53),
...
('110305', 10540, '*บางเสาธง   ', '*Bang Sao Thong', 54),
('110306', 10540, '*ศรีษะจรเข้ใหญ่   ', '*Srisa Jorrakae Yai', 54),
('110307', 10540, '*ศรีษะจรเข้น้อย   ', '*Srisa Jorrakae Noi', 54),
...
('160113', 15000, '*ทะเลชุบศร   ', '*Thalay Chup Sorn', 97),
...
('160311', 15120, '*ชอนสารเดช   ', '*Chon Sara Dach', 99),
('160312', 15120, '*หนองม่วง   ', '*Nong Muang', 99),
('160313', 15120, '*บ่อทอง   ', '*Bo Thong', 99),
('160314', 15120, '*ยางโทน   ', '*Yang Tong', 99),
('160315', 15120, '*ชอนสมบูรณ์   ', '*Chon Somboon', 99),
('160316', 15120, '*โคกเจริญ   ', '*Khok Jaroen', 99),
('160317', 15120, '*ยางราก   ', '*Yang Rag', 99),
('160318', 15120, 'วังขอนขว้าง   ', 'Wang Khon Khwang', 99),
('160319', 15120, '*ดงดินแดง   ', '*Dong Din Dang', 99),
('160320', 15120, 'วังจั่น   ', 'Wang Chan', 99),
('160321', 15120, '*หนองมะค่า   ', '*Nong Maka', 99),
('160322', 15120, 'หนองแขม   ', 'Nong Khaem', 99),
('160323', 15120, '*วังทอง   ', '*Wang Thong', 99),
('160389', 15120, '*ชอนสารเดช   ', '*Chon Saradach', 99),
('160390', 15120, '*ยางโทน   ', '*Yang Tong', 99),
('160391', 15120, '*ชอนสมบูรณ์   ', '*Chon Somboon', 99),
('160392', 15120, '*ดงดินแดง   ', '*Dong Din Dang', 99),
('160393', 15120, '*บ่อทอง   ', '*Bo Thong', 99),
('160394', 15120, '*หนองม่วง   ', '*Nong Muang', 99),
('160395', 15120, '*ยางราก   ', '*Yang Rag', 99),
('160396', 15120, '*โคกเจริญ   ', '*Khok Jaroen', 99),
('160397', 15120, '*ทุ่งท่าช้าง   ', '*Thung Tha Chang', 99),
('160398', 15120, '*มหาโพธิ์   ', '*Sri Maha Phot', 99),
('160399', 15120, '*สระโบสถ์   ', '*Sa Bos', 99),
...
('160413', 15130, '*หนองรี   ', '*Nong Ree', 100),
('160414', 15130, 'ท่ามะนาว   ', 'Tha Manao', 100),
('160415', 15130, '*กุดตาเพชร   ', '*Kud Ta Phech', 100),
('160416', 15130, '*ลำสนธิ   ', '*Lam Sonti', 100),
...
('160420', 15130, '*ซับสมบูรณ์   ', '*Sub Somboon', 100),
('160421', 15130, '*เขารวก   ', '*Khao Ruak', 100),
('160422', 15130, 'เขาแหลม   ', 'Khao Laem', 100),
('160492', 15130, '*เขาฉกรรจ์   ', '*Khao Chakan', 100),
('160493', 15130, '*กุดตาเพชร   ', '*Kud Ta Phech', 100),
('160494', 15130, '*หนองรี   ', '*Nong Ree', 100),
('160495', 15130, '*ลำสนธิ   ', '*Lam Sonti', 100),
('160496', 15130, '*หนองผักแว่น   ', '*Nong Phak Waen', 100),
('160497', 15130, '*ซับจำปา   ', '*Sub Jumpa', 100),
('160498', 15130, '*แก่งผักกูด   ', '*Kaeng Pak Kud', 100),
('160499', 15130, '*ท่าหลวง   ', '*Tha Loung', 100),
...
('180305', 17120, 'หนองมะโมง*   ', 'Nong Khun*', 117),
('180306', 17120, 'หนองขุ่น   ', 'Bo Rae', 117),
('180307', 17120, 'บ่อแร่   ', 'Wang Man', 117),
('180308', 17120, 'กุดจอก*   ', 'Good Jokk*', 117),
('180309', 17120, 'วังตะเคียน*   ', 'Wang Takean*', 117),
('180310', 17120, 'สะพานหิน*   ', 'Sapan Hin*', 117),
...
('180603', 17130, 'เนินขาม*   ', 'Nern Kham*', 120),
('180604', 17130, 'สุขเดือนห้า*   ', 'Suk Dean Ha*', 120),
...
('180610', 17130, 'กะบกเตี้ย*   ', 'Kabok Tia*', 120),
...
('190102', 18000, 'หน้าพระลาน*   ', 'Na Phra Lan*', 123),
('190103', 18000, 'พุแค*   ', 'Phu Kae*', 123),
('190104', 18000, 'ห้วยบง*   ', 'Hauy Bong*', 123),
...
('190115', 18000, 'บ้านแก้ง*   ', 'Baan Kang*', 123),
('190116', 18000, 'ผึ้งรวง*   ', 'Phueng Ruang*', 123),
('190117', 18000, 'เขาดินพัฒนา*   ', 'Kao Din Pattana*', 123),
...
('190696', 18130, '*ดงตะงาว   ', '*Dong Ta Ngaow', 128),
('190697', 18130, '*บ้านหลวง   ', '*Ban Loung', 128),
('190698', 18130, '*ไผ่หลิ่ว   ', '*Phai Lio', 128),
('190699', 18130, '*ดอนพุด   ', '*Don Phud', 128),
...
('200199', 20000, 'เทศบาลเมืองชลบุรี*   ', 'Tetsaban Chonburi*', 136),
...
('200297', 20220, '*หนองเสือช้าง   ', '*Nong Sua Chang', 137),
('200298', 20220, '*คลองพลู   ', '*Klong Plu', 137),
('200299', 20220, '*หนองใหญ่   ', '*Nong Yai', 137),
...
('200612', 20140, 'ท่าบุญมี**   ', 'Ta Bun Mee**', 141),
...
('200619', 20140, 'เกาะจันทร์**   ', 'Koh Chan**', 141),
('200620', 20140, 'โคกเพลาะ   ', 'Khok Phlo', 141),
('200621', 20140, 'ไร่หลักทอง   ', 'Rai Lak Thong', 141),
('200622', 20140, 'นามะตูม   ', 'Na Matum', 141),
('200623', 20140, '*บ้านเซิด   ', '*Ban Serd', 141),
('200696', 20140, '*พูนพัฒนาทรัพย์   ', '*Poon Pattana Sub', 141),
('200697', 20140, '*บ่อกวางทอง   ', '*Bo Kwang Thong', 141),
('200698', 20140, '*วัดสุวรรณ   ', '*Wat Suwan', 141),
('200699', 20140, '*บ่อทอง   ', '*Bor Thong', 141),
...
('200799', 20120, '*ท่าเทววงษ์   ', '*Ta Tewa Wong', 142),
...
('210198', 21100, '*สำนักท้อน   ', '*Sumnak Torn', 151),
('210199', 21100, '*พลา   ', '*Pla', 151),
...
('210314', 21170, '*น้ำเป็น   ', '*Nam Phen', 153),
('210315', 21170, '*ชำฆ้อ   ', '*Cham Kho', 153),
('210316', 21170, '*ห้วยทับมอญ   ', '*Huay Tab Mon', 153),
('210317', 21110, 'ห้วยยาง   ', 'Huai Yang', 153),
('210318', 21110, 'สองสลึง   ', 'Song Salueng', 153),
('210319', 21110, '*เขาน้อย   ', '*Khao Noi', 153),
...
('210508', 21120, 'มาบข่า*   ', 'Mab Kha*', 155),
('210509', 21120, 'พนานิคม*   ', 'Pana Nikhom*', 155),
('210510', 21120, 'นิคมพัฒนา*   ', 'Nikhom Pattana*', 155),
('210511', 21120, 'มะขามคู่*   ', 'Makham Khu*', 155),
('210594', 21120, '*หนองไร่   ', '*Nong Rai', 155),
('210595', 21120, '*มาบยางพร   ', '*Mab Yang Porn', 155),
('210596', 21120, '*แม่น้ำคู้   ', '*Mae Nam Koo', 155),
('210597', 21120, '*ละหาร   ', '*La Han', 155),
('210598', 21120, '*ตาสิทธิ์   ', '*Ta Sit', 155),
('210599', 21120, '*ปลวกแดง   ', '*Pluak Daeng', 155),
...
('220310', 22170, '*วังโตนด   ', '*Wang Tanode', 162),
...
('220315', 22120, '*กระแจะ   ', '*Kra Jae', 162),
('220316', 22170, '*สนามไชย   ', '*Sanam Chai', 162),
('220317', 22170, '*ช้างข้าม   ', '*Chang Kham', 162),
('220318', 22170, '*นายายอาม   ', '*Na Yai Am', 162),
('220319', 22170, '*แก่งหางแมว   ', '*Kaeng Hang Maeo', 162),
('220320', 22170, '*สามพี่น้อง   ', '*Sam Pee Nong', 162),
('220321', 22170, '*เขาวงกต   ', '*Khao Wongkot', 162),
('220322', 22170, '*พวา   ', '*Pawa', 162),
('220323', 22170, '*ขุนซ่อง   ', '*Khun Song', 162),
('220324', 22170, 'เขาแก้ว   ', 'Khao Kaeo', 162),
('220394', 22170, '*กระแจะ   ', '*Kra Jae', 162),
('220395', 22170, '*สนามไช   ', '*Sanam Chai', 162),
('220396', 22170, '*ช้างข้าม   ', '*Chang Kham', 162),
('220397', 22170, '*วังโตนด   ', '*Wang Tanode', 162),
('220398', 22170, '*นายายอาม   ', '*Na Yai Am', 162),
('220399', 22170, '*แก่งหางแมว   ', '*Kaeng Hang Maeo', 162),
('220401', 22140, 'ทับไทร   ', 'Thap Sai', 163),
('220402', 22140, 'โป่งน้ำร้อน   ', 'Pong Nam Ron', 163),
('220403', 22140, '*ทรายขาว   ', '*Sai Khao', 163),
('220404', 22140, 'หนองตาคง   ', 'Nong Ta Khong', 163),
('220405', 22140, '*ปะตง   ', '*Pa Tong', 163),
('220406', 22140, '*ทุ่งขนาน   ', '*Thung Khanan', 163),
('220407', 22140, '*สะตอน   ', '*Saton', 163),
('220408', 22140, '*ทับช้าง   ', '*Thap Chang', 163),
...
('220505', 22150, '*พลวง   ', '*Pluang', 164),
('220506', 22150, 'ฉมัน   ', 'Chaman', 164),
('220507', 22150, '*ตะเคียนทอง   ', '*Takean Tong', 164),
('220508', 22150, 'อ่างคีรี   ', 'Ang Khiri', 164),
('220509', 22150, '*คลองพลู   ', '*Klong Plu', 164),
('220510', 22150, '*ซากไทย   ', '*Chak Thai', 164),
...
('230395', 23130, '*บ่อไร่   ', '*Bor Rai', 173),
('230396', 23130, '*ด่านชุมพล   ', '*Dan Chumpol', 173),
('230397', 23130, '*หนองบอน   ', '*Nong Bon', 173),
('230398', 23130, '*ช้างทูน   ', '*Chang Toon', 173),
('230399', 23130, '*บ่อพลอย   ', '*Bor Ploy', 173),
...
('950105', 95000, '*ปุโรง   ', '*Pu Rong', 977),
('950106', 95000, 'ยะลา   ', 'Yala', 977),
('950107', 95000, '*สะเอะ   ', '*Sa Ae', 977),
...
('950117', 95000, '*ห้วยกระทิง   ', '*Hua Krating', 977),
...
('950397', 95130, '*แม่หวาด   ', '*Mae Wad', 979),
('950398', 95130, '*บ้านแหร   ', '*Ban Rae', 979),
('950399', 95130, '*ธารโต   ', '*Tan To', 979),
...
(1, NULL, 'Item Management', '/item', 'fas fa-carrot', 0, 'on', 'main', '2020-03-05 13:49:01', '2020-03-05 14:32:09', NULL),
(2, 1, 'Item', '/item', NULL, NULL, 'on', 'secondary', '2020-03-05 13:49:19', '2020-03-06 15:24:30', NULL),
(3, 1, 'Unit Count', '/unitcount', NULL, NULL, 'on', 'secondary', '2020-03-05 13:49:41', '2020-03-06 14:59:05', NULL),
(4, NULL, 'Vendor Management', '/vendors', 'fas fa-users', 0, 'on', 'main', '2020-03-05 14:11:00', '2020-04-18 18:20:08', NULL),
(5, NULL, 'Purchase order', '/po', 'fas fa-file-alt', 8, 'on', 'main', '2020-03-05 14:40:12', '2020-05-10 23:04:57', NULL),
(8, NULL, 'Orders', '/invoice', 'fas fa-file-alt', 17, 'on', 'main', '2020-03-17 16:43:25', '2020-08-31 11:04:37', NULL),
(9, NULL, 'Products Setup', '/box', 'fas fa-box-open', 7, 'on', 'main', '2020-03-18 15:06:49', '2020-05-10 23:04:57', NULL),
(10, 9, 'Boxes', '/box', NULL, NULL, 'on', 'secondary', '2020-03-18 15:07:17', '2020-03-18 15:26:34', NULL),
(11, 9, 'Packaging', '/packaging', NULL, NULL, 'on', 'secondary', '2020-03-18 15:07:40', '2020-03-18 15:26:42', NULL),
(12, NULL, 'Receiving', '/receive', 'fas fa-box', 11, 'on', 'main', '2020-03-20 20:48:06', '2020-05-10 23:04:57', NULL),
(13, NULL, 'Inventory', '/inventory', 'fas fa-boxes', 12, 'on', 'main', '2020-03-24 14:41:01', '2020-05-10 23:04:57', NULL),
(14, NULL, 'Sorting', '/sorting', 'fas fa-sort', 11, 'on', 'main', '2020-03-26 21:17:21', '2020-05-10 23:04:57', NULL),
(16, NULL, 'ASL', '/asl', 'fas fa-check-circle', 11, 'on', 'main', '2020-04-01 17:35:18', '2020-05-10 23:04:57', NULL),
(17, 9, 'EAN', '/setup', NULL, NULL, 'on', 'secondary', '2020-04-02 11:41:59', '2020-04-08 16:33:21', NULL),
(18, 9, 'ITF', '/itf', NULL, NULL, 'on', 'secondary', '2020-04-08 10:09:39', '2020-04-08 10:09:39', NULL),
(19, NULL, 'Packing', '/packing', 'fas fa-tape', 11, 'on', 'main', '2020-04-10 15:07:16', '2020-05-10 23:04:57', NULL),
(20, NULL, 'Airport Management', '/airport', 'fas fa-plane', 0, 'on', 'main', '2020-04-17 13:17:31', '2020-05-10 23:23:57', NULL),
(21, NULL, 'Client Mnagement', '/client', 'fas fa-user-tag', 4, 'on', 'main', '2020-04-17 18:05:47', '2020-05-10 23:04:04', NULL),
(22, 21, 'Client', '/client', NULL, NULL, 'on', 'secondary', '2020-04-19 17:41:44', '2020-04-19 17:41:52', NULL),
(23, 21, 'Ship To', '/shipto', NULL, NULL, 'on', 'secondary', '2020-04-19 18:01:26', '2020-04-19 18:01:26', NULL),
(24, NULL, 'Clearance Management', '/clearance', 'fas fa-money-check-alt', 5, 'on', 'main', '2020-04-20 15:11:49', '2020-05-10 23:04:04', NULL),
(25, NULL, 'Transportation Management', '/transport', 'fas fa-truck', 7, 'on', 'main', '2020-04-20 17:58:44', '2020-05-10 23:04:57', NULL),
(26, NULL, 'Order', '/order', 'fas fa-truck-loading', 12, 'off', 'main', '2020-04-23 14:20:17', '2020-05-14 20:22:32', NULL),
(27, NULL, 'Freight Management', '/freight', 'fas fa-plane-departure', 3, 'on', 'main', '2020-05-08 16:47:04', '2020-05-10 23:04:04', NULL),
(28, NULL, 'Airline Management', '/airline', 'fas fa-plane-arrival', 0, 'on', 'main', '2020-05-10 19:22:23', '2020-05-10 23:23:51', NULL),
(29, NULL, 'Currency Management', '/currency', 'fas fa-dollar-sign', 6, 'on', 'main', '2020-05-10 22:29:10', '2020-05-10 23:04:57', NULL),
(30, 19, 'packing', '/packing', NULL, NULL, 'on', 'secondary', '2020-05-13 17:39:15', '2020-05-13 17:39:15', NULL),
(31, 19, 'HPL', '/hpl', NULL, NULL, 'on', 'secondary', '2020-05-13 17:39:31', '2020-05-13 17:39:31', NULL),
(32, 8, 'Quotation', '/quotation', NULL, NULL, 'on', 'secondary', '2020-05-15 10:43:27', '2020-08-31 11:31:18', NULL),
(33, 8, 'Order', '/order', NULL, NULL, 'on', 'secondary', '2020-05-22 16:39:14', '2020-05-22 16:39:14', NULL),
(34, 8, 'Operation', '/operation', NULL, NULL, 'on', 'secondary', '2020-08-31 10:23:13', '2020-08-31 10:23:13', NULL),
(35, 8, 'Invoice', '/invoice', NULL, NULL, 'on', 'secondary', '2020-05-15 10:43:50', '2020-05-15 10:43:50', NULL),
(38, 9, 'Pallets', '/pallets', NULL, NULL, 'on', 'secondary', NULL, NULL, NULL);
...
CREATE TABLE `transection` (
  `id` bigint(20) NOT NULL,
  `transection_type` varchar(255) DEFAULT NULL COMMENT 'buy, waste, restore, sold',
  `transection_menu` varchar(255) DEFAULT NULL,
  ...
  `qty` decimal(10,2) DEFAULT NULL,
  `good_qty` decimal(10,2) DEFAULT NULL,
  `waste_qty` decimal(10,2) DEFAULT NULL,
  `transection_date` datetime DEFAULT NULL,
  `receiving_cost` decimal(10,2) NOT NULL DEFAULT '0.00',
  `transactionValue` decimal(10,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transection` (`id`, `transection_type`, `transection_menu`, `ref_id`, `type`, `item_id`, `code`, `unit`, `qty`, `good_qty`, `waste_qty`, `transection_date`, `receiving_cost`, `transactionValue`) VALUES
(1, 'buy', 'receive', 1, 'packaging', 4, 'PO2021060001005', 3, '100000.00', '100000.00', '0.00', '2021-06-06 07:53:14', '2.00', '200000.00'),
(2, 'buy', 'receive', 2, 'item', 2, 'PO2021060001003', 1, '100.00', '100.00', '0.00', '2021-06-06 07:55:15', '10.00', '1000.00'),
(3, 'buy', 'receive', 3, 'item', 1, 'PO2021060001001', 2, '2000.00', '1999.00', '0.00', '2021-06-06 07:56:20', '20.00', '40000.00'),
(4, 'buy', 'receive', 4, 'item', 1, 'PO2021060001002', 2, '2000.00', '2000.00', '0.00', '2021-06-06 07:56:41', '20.00', '40000.00'),
(5, 'waste', 'sorting', 1, 'item', 2, 'PO2021060001003', 1, '-10.00', '90.00', '-10.00', '2021-06-06 07:57:45', '10.00', '-100.00'),
(6, 'waste', 'sorting', 2, 'item', 1, 'PO2021060001001', 2, '-199.00', '1800.00', '-200.00', '2021-06-06 07:58:57', '20.00', '-4000.00'),
(7, 'waste', 'sorting', 3, 'item', 1, 'PO2021060001002', 2, '-400.00', '1600.00', '-400.00', '2021-06-06 07:59:45', '20.00', '-8000.00'),
(9, 'waste', 'packed', 2, 'item', 1, 'PO2021060001001', 2, '-400.00', '1200.00', '-400.00', '2021-06-06 08:26:15', '20.00', '-8000.00'),
(11, 'buy', 'receive', 5, 'packaging', 5, 'PO2021060001006', 4, '100000.00', '100000.00', '0.00', '2021-06-06 13:51:40', '2.00', '200000.00'),
(14, 'buy', 'receive', 6, 'boxes', 3, 'PO2021060001004', 5, '5000.00', '5000.00', '0.00', '2021-06-14 15:47:57', '20.00', '100000.00'),
(18, 'buy', 'receive', 7, 'item', 1, 'PO2021060002001', 2, '400.00', '400.00', '0.00', '2021-06-15 09:33:40', '40.00', '16000.00'),
(19, 'waste', 'sorting', 4, 'item', 1, 'PO2021060002001', 2, '-80.00', '320.00', '-80.00', '2021-06-15 09:35:05', '40.00', '-3200.00'),
(55, 'waste', 'packed', 43, 'item', 1, 'PO2021060001001', 2, '-1200.00', '400.00', '-1200.00', '2021-07-02 13:01:51', '20.00', '-24000.00'),
(58, 'waste', 'packed', 46, 'item', 1, 'PO2021060001002', 2, '-100.00', '1500.00', '-100.00', '2021-07-02 15:30:45', '20.00', '-2000.00'),
(59, 'waste', 'packed', 47, 'item', 2, 'PO2021060001003', 1, '-10.00', '80.00', '-10.00', '2021-07-02 17:42:31', '10.00', '-100.00');
...
CREATE TABLE `transport` (
  `id` bigint(20) NOT NULL,
  `vendor` bigint(20) DEFAULT NULL,
  `small_max_cbm` decimal(10,2) DEFAULT NULL,
  `small_max_weight` decimal(10,2) DEFAULT NULL,
  `small_pallet` decimal(10,0) DEFAULT NULL,
  `small_price` decimal(10,2) DEFAULT NULL,
  `medium_max_cbm` decimal(10,2) DEFAULT NULL,
  `medium_max_weight` decimal(10,2) DEFAULT NULL,
  `medium_pallet` decimal(10,0) DEFAULT NULL,
  `medium_price` decimal(10,2) DEFAULT NULL,
  `large_max_cbm` decimal(10,2) DEFAULT NULL,
  `large_max_weight` decimal(10,2) DEFAULT NULL,
  `large_pallet` decimal(10,0) DEFAULT NULL,
  `large_price` decimal(10,2) DEFAULT NULL,
  `jumbo_max_cbm` decimal(10,2) DEFAULT NULL,
  `jumbo_max_weight` decimal(10,2) DEFAULT NULL,
  `jumbo_pallet` decimal(10,0) DEFAULT NULL,
  `jumbo_price` decimal(10,2) DEFAULT NULL,
  `status` enum('on','off') DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `updated` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transport` (`id`, `vendor`, `small_max_cbm`, `small_max_weight`, `small_pallet`, `small_price`, `medium_max_cbm`, `medium_max_weight`, `medium_pallet`, `medium_price`, `large_max_cbm`, `large_max_weight`, `large_pallet`, `large_price`, `jumbo_max_cbm`, `jumbo_max_weight`, `jumbo_pallet`, `jumbo_price`, `status`, `created`, `updated`) VALUES
(1, 1, '2.00', '2000.00', '2', '1000.00', '4.00', '6000.00', '4', '2000.00', '6.00', '8000.00', '6', '4000.00', '8.00', '12000.00', '8', '6000.00', 'on', '2021-06-14 19:48:31', '2021-06-25 08:22:04');
...
INSERT INTO `unit_count` (`id`, `name_th`, `name_en`, `sort`, `status`, `created`, `updated`) VALUES
(1, 'PC', 'PC', 5, 'on', '2021-03-11 18:28:51', '2021-03-12 16:36:13'),
(2, 'KG', 'KG', 4, 'on', '2021-03-11 18:29:01', '2021-03-12 16:36:06'),
(3, 'Sleeve', 'Sleeve', 3, 'on', '2021-03-11 18:29:14', '2021-03-12 16:35:58'),
(4, 'Sticker', 'Sticker', 2, 'on', '2021-03-11 18:29:24', '2021-03-12 16:35:51'),
(5, 'Box', 'BOX', 1, 'on', '2021-03-11 18:29:35', '2021-03-12 16:35:41');
...
INSERT INTO `users` (`id`, `role`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `status`, `last_login`, `created_at`, `updated_at`, `permission`) VALUES
(1, 'superadmin', 'Administrator', 'admin@admin.com', NULL, '$2y$12$PHGJiDPXD9siu3755DL5D.wOQxxsWjJolR0rqUf9p9IBEMH/uMtyu', NULL, 'active', '2021-02-02 11:53:52', NULL, NULL, 1),
(2, 'admin', 'Admin', 'admin@test.com', NULL, '$2y$10$B9Lo6mEIDONpryCCuVtD6.7DsMJETURUDeWRfq8gQE8AWCXaKN.Oa', 'YttJ3YkBddx9vRZMzB8s31BhMPXWfPGbNla6z7e6onbkcrlNymFurB7Ie3aU', 'active', '2020-06-28 20:24:23', '2020-03-06 18:18:10', '2020-06-26 10:30:03', 1),
(5, 'staff', 'Neng', '0828938493', NULL, '$2y$10$5IZYTasjQTqx1lczD02Id./gSXyBWToRRtdPb1H1PeClLtK5O6Iui', 'eI5DAU6FnVuEZ69XeeaJKhtrwVlOwmXSkQhk2wPBzKJmuEtIkn0QqqbXbB3t', 'active', '2021-03-01 09:06:25', '2020-06-25 11:17:37', '2020-06-25 11:17:37', 1),
(6, 'superadmin', 'Zeid', '0884924252', NULL, '$2y$10$ZHnNdlzcNz5Q63JrkCRpu.GbZjq6IsIfWKmCTnsFqw3HuzB01VfwG', 'zoQ8uxjzGLkEPpU0DGxEH9melqZlIqMpaEiL7G1kAKts8m3QBVrM9sI6XDUr', 'active', '2021-08-04 20:12:04', '2020-06-25 11:20:38', '2020-06-25 11:20:38', 1),
(7, 'staff', 'Kong', '0928241644', NULL, '$2y$10$UKlmqzsTtlFXK0G.tVP77e/bSil2wXEJ1TogHm3gs/l7bf3mc6Hu.', NULL, 'active', '2020-07-22 19:23:31', '2020-06-25 11:22:22', '2020-06-26 14:11:43', 1),
(8, 'staff', 'Wat', 'Wat', NULL, '$2y$10$bgzuWcZzVUTkjhgfcIvwxObBySz/5KADCoKQuCdL9Kl75jafuf0GK', NULL, 'active', '2020-10-07 13:28:31', '2020-06-26 13:53:49', '2020-06-26 13:53:49', 1),
(10, 'admin', 'Mui', '0616123312', NULL, '$2y$10$MugG1J.wrYzde/1SVhkEIuf6oM.CYnlez3ET7eE2gBlyF6xUrFqXq', NULL, 'active', '2020-08-13 14:36:28', '2020-07-11 16:45:43', '2020-07-11 16:45:43', 1),
(11, 'admin', 'Giig', 'Giig', NULL, '$2y$10$N199anyWL9A8E1pLkqqW9ObWRZKSAF33acsquB25g8QG2ZfY0.zaS', NULL, 'active', '2021-02-26 12:38:35', '2020-12-02 11:29:49', '2020-12-02 11:29:49', 1),
(12, 'admin', 'NARENDRA', 'Narendra', NULL, '$2y$10$s1zuJn7p.Q7NkHLJXPmugu7Qz4CoImHcSjEyfeKT6iWZ8FIZEH10.', 'myiMDp4AfvBt0Myhj1AfsuGuLA9h28FLl6leEzfXcnciY8Bo6WarpQCIKXmi', 'active', '2021-08-02 18:08:06', '2021-02-16 17:19:27', '2021-05-26 20:18:28', 1),
(13, 'staff', 'Sudhir Mandal', 'sudhir', NULL, '$2y$10$0qk0rNkJNnosnNg55JY67O1KnErGKC7VjMBUPChmH/SztJhR7sUP6', NULL, 'inactive', NULL, '2021-05-26 12:44:41', '2021-05-26 12:44:41', 1),
(14, 'staff', 'Level 2', 'lvl2', NULL, '$2y$10$gQe9qy5bFqN3dU/FLBJEpuJf8ZEgoiBo6pRiXELmwWbIE5kMiRKAq', NULL, 'active', '2021-05-28 16:59:01', '2021-05-26 13:46:53', '2021-05-27 17:55:17', 2),
(15, 'staff', 'Level 4', 'Level 4', NULL, '$2y$10$gcKvsSnH8eazyvYFUubMweJjhRKb7EYngiFsT7mNPWXHlHnTG7GEK', NULL, 'active', '2021-05-28 16:57:31', '2021-05-28 16:44:59', '2021-05-28 16:44:59', 4);
...
CREATE TABLE `vendors` (
  ...
  `type` varchar(255) DEFAULT NULL,
  `address` text,
  `subdistrict` int(13) DEFAULT NULL,
  `district` int(13) DEFAULT NULL,
  `provinces` int(13) DEFAULT NULL,
  `postcode` int(13) DEFAULT NULL,
  `country` varchar(255) DEFAULT NULL,
...
INSERT INTO `vendors` (`id`, `name`, `id_card`, `type`, `address`, `subdistrict`, `district`, `provinces`, `postcode`, `country`, `line_id`, `phone`, `email`, `bank_name`, `bank_number`, `bank_account`, `status`, `sort`, `created`, `updated`) VALUES
(1, 'Test Vendor', '1245678901233', 'company', 'cs', 130404, 69, 4, 12170, NULL, NULL, '0987654321', NULL, NULL, NULL, NULL, 'on', 1, '2021-03-10 13:04:53', '2021-03-10 13:04:53');
...
--
-- Indexes for table `average_lot`
--
ALTER TABLE `average_lot`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cal_cost`
--
ALTER TABLE `cal_cost`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `itf_detail`
--
ALTER TABLE `itf_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `average_lot`
--
ALTER TABLE `average_lot`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cal_cost`
--
ALTER TABLE `cal_cost`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `itf_detail`
--
ALTER TABLE `itf_detail`
...
--
-- AUTO_INCREMENT for table `shiptos`
--
ALTER TABLE `shiptos`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
